...
class NestedEntanglementOptical212Frag(ExpFragment):
    """Nested Experiment Nested_Entanglement_Optical_212
...
NestedEntanglementOptical212 = make_fragment_scan_exp(NestedEntanglementOptical212Frag)
