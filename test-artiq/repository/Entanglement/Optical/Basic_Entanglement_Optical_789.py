...
class BasicEntanglementOptical789Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Entanglement_Optical_789
...
BasicEntanglementOptical789 = make_fragment_scan_exp(BasicEntanglementOptical789Frag)
