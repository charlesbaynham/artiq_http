...
class BasicEntanglementOptical590Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Entanglement_Optical_590
...
BasicEntanglementOptical590 = make_fragment_scan_exp(BasicEntanglementOptical590Frag)
