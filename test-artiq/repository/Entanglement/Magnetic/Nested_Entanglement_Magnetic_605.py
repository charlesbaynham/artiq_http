...
class NestedEntanglementMagnetic605Frag(ExpFragment):
    """Nested Experiment Nested_Entanglement_Magnetic_605
...
NestedEntanglementMagnetic605 = make_fragment_scan_exp(NestedEntanglementMagnetic605Frag)
