...
class BasicEntanglementMagnetic505Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Entanglement_Magnetic_505
...
BasicEntanglementMagnetic505 = make_fragment_scan_exp(BasicEntanglementMagnetic505Frag)
