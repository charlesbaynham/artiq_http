...
class BasicEntanglementMagnetic465Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Entanglement_Magnetic_465
...
BasicEntanglementMagnetic465 = make_fragment_scan_exp(BasicEntanglementMagnetic465Frag)
