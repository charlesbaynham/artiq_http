...
class NestedEntanglementLaser520Frag(ExpFragment):
    """Nested Experiment Nested_Entanglement_Laser_520
...
NestedEntanglementLaser520 = make_fragment_scan_exp(NestedEntanglementLaser520Frag)
