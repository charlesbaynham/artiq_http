...
class NestedEntanglementLaser843Frag(ExpFragment):
    """Nested Experiment Nested_Entanglement_Laser_843
...
NestedEntanglementLaser843 = make_fragment_scan_exp(NestedEntanglementLaser843Frag)
