...
class MultiEntanglementLaser920Frag(ExpFragment):
    """Multi-channel Experiment Multi_Entanglement_Laser_920
...
MultiEntanglementLaser920 = make_fragment_scan_exp(MultiEntanglementLaser920Frag)
