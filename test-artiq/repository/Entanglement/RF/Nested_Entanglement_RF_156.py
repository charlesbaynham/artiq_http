...
class NestedEntanglementRF156Frag(ExpFragment):
    """Nested Experiment Nested_Entanglement_RF_156
...
NestedEntanglementRF156 = make_fragment_scan_exp(NestedEntanglementRF156Frag)
