...
class MultiEntanglementRF432Frag(ExpFragment):
    """Multi-channel Experiment Multi_Entanglement_RF_432
...
MultiEntanglementRF432 = make_fragment_scan_exp(MultiEntanglementRF432Frag)
