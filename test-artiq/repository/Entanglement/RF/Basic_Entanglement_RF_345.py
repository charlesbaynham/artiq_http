...
class BasicEntanglementRF345Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Entanglement_RF_345
...
BasicEntanglementRF345 = make_fragment_scan_exp(BasicEntanglementRF345Frag)
