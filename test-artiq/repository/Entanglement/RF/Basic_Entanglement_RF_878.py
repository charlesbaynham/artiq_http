...
class BasicEntanglementRF878Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Entanglement_RF_878
...
BasicEntanglementRF878 = make_fragment_scan_exp(BasicEntanglementRF878Frag)
