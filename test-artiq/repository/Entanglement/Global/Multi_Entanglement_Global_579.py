...
class MultiEntanglementGlobal579Frag(ExpFragment):
    """Multi-channel Experiment Multi_Entanglement_Global_579
...
MultiEntanglementGlobal579 = make_fragment_scan_exp(MultiEntanglementGlobal579Frag)
