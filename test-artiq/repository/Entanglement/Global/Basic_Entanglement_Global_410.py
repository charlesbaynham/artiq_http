...
class BasicEntanglementGlobal410Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Entanglement_Global_410
...
BasicEntanglementGlobal410 = make_fragment_scan_exp(BasicEntanglementGlobal410Frag)
