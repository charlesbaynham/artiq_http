...
class MultiEntanglementGlobal432Frag(ExpFragment):
    """Multi-channel Experiment Multi_Entanglement_Global_432
...
MultiEntanglementGlobal432 = make_fragment_scan_exp(MultiEntanglementGlobal432Frag)
