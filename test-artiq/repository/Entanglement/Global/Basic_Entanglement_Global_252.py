...
class BasicEntanglementGlobal252Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Entanglement_Global_252
...
BasicEntanglementGlobal252 = make_fragment_scan_exp(BasicEntanglementGlobal252Frag)
