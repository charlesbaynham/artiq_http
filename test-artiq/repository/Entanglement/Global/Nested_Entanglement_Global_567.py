...
class NestedEntanglementGlobal567Frag(ExpFragment):
    """Nested Experiment Nested_Entanglement_Global_567
...
NestedEntanglementGlobal567 = make_fragment_scan_exp(NestedEntanglementGlobal567Frag)
