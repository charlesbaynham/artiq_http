...
class BasicTrappingMagnetic826Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Trapping_Magnetic_826
...
BasicTrappingMagnetic826 = make_fragment_scan_exp(BasicTrappingMagnetic826Frag)
