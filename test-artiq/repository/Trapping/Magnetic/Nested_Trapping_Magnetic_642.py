...
class NestedTrappingMagnetic642Frag(ExpFragment):
    """Nested Experiment Nested_Trapping_Magnetic_642
...
NestedTrappingMagnetic642 = make_fragment_scan_exp(NestedTrappingMagnetic642Frag)
