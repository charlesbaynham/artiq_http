...
class NestedTrappingMagnetic147Frag(ExpFragment):
    """Nested Experiment Nested_Trapping_Magnetic_147
...
NestedTrappingMagnetic147 = make_fragment_scan_exp(NestedTrappingMagnetic147Frag)
