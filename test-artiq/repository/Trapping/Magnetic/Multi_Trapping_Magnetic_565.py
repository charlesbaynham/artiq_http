...
class MultiTrappingMagnetic565Frag(ExpFragment):
    """Multi-channel Experiment Multi_Trapping_Magnetic_565
...
MultiTrappingMagnetic565 = make_fragment_scan_exp(MultiTrappingMagnetic565Frag)
