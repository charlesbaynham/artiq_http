...
class BasicTrappingOptical476Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Trapping_Optical_476
...
BasicTrappingOptical476 = make_fragment_scan_exp(BasicTrappingOptical476Frag)
