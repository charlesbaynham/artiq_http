...
class MultiTrappingOptical721Frag(ExpFragment):
    """Multi-channel Experiment Multi_Trapping_Optical_721
...
MultiTrappingOptical721 = make_fragment_scan_exp(MultiTrappingOptical721Frag)
