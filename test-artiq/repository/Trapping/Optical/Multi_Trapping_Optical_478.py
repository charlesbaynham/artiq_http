...
class MultiTrappingOptical478Frag(ExpFragment):
    """Multi-channel Experiment Multi_Trapping_Optical_478
...
MultiTrappingOptical478 = make_fragment_scan_exp(MultiTrappingOptical478Frag)
