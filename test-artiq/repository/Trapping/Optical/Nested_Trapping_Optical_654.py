...
class NestedTrappingOptical654Frag(ExpFragment):
    """Nested Experiment Nested_Trapping_Optical_654
...
NestedTrappingOptical654 = make_fragment_scan_exp(NestedTrappingOptical654Frag)
