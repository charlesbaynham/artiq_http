...
class MultiTrappingRF462Frag(ExpFragment):
    """Multi-channel Experiment Multi_Trapping_RF_462
...
MultiTrappingRF462 = make_fragment_scan_exp(MultiTrappingRF462Frag)
