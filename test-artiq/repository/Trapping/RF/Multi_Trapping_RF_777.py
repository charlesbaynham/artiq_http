...
class MultiTrappingRF777Frag(ExpFragment):
    """Multi-channel Experiment Multi_Trapping_RF_777
...
MultiTrappingRF777 = make_fragment_scan_exp(MultiTrappingRF777Frag)
