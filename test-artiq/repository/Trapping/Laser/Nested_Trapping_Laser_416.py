...
class NestedTrappingLaser416Frag(ExpFragment):
    """Nested Experiment Nested_Trapping_Laser_416
...
NestedTrappingLaser416 = make_fragment_scan_exp(NestedTrappingLaser416Frag)
