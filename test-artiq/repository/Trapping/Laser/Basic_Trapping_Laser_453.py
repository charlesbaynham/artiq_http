...
class BasicTrappingLaser453Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Trapping_Laser_453
...
BasicTrappingLaser453 = make_fragment_scan_exp(BasicTrappingLaser453Frag)
