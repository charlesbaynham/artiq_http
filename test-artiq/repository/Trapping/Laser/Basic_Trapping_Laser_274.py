...
class BasicTrappingLaser274Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Trapping_Laser_274
...
BasicTrappingLaser274 = make_fragment_scan_exp(BasicTrappingLaser274Frag)
