...
class NestedTrappingLaser114Frag(ExpFragment):
    """Nested Experiment Nested_Trapping_Laser_114
...
NestedTrappingLaser114 = make_fragment_scan_exp(NestedTrappingLaser114Frag)
