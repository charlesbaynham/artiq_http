...
class BasicTrappingLaser183Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Trapping_Laser_183
...
BasicTrappingLaser183 = make_fragment_scan_exp(BasicTrappingLaser183Frag)
