...
class MultiTrappingGlobal656Frag(ExpFragment):
    """Multi-channel Experiment Multi_Trapping_Global_656
...
MultiTrappingGlobal656 = make_fragment_scan_exp(MultiTrappingGlobal656Frag)
