...
class BasicTrappingGlobal864Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Trapping_Global_864
...
BasicTrappingGlobal864 = make_fragment_scan_exp(BasicTrappingGlobal864Frag)
