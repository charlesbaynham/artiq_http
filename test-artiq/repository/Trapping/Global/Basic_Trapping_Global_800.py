...
class BasicTrappingGlobal800Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Trapping_Global_800
...
BasicTrappingGlobal800 = make_fragment_scan_exp(BasicTrappingGlobal800Frag)
