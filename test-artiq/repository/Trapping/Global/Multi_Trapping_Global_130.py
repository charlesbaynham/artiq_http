...
class MultiTrappingGlobal130Frag(ExpFragment):
    """Multi-channel Experiment Multi_Trapping_Global_130
...
MultiTrappingGlobal130 = make_fragment_scan_exp(MultiTrappingGlobal130Frag)
