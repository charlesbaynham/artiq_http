...
class MultiTrappingGlobal680Frag(ExpFragment):
    """Multi-channel Experiment Multi_Trapping_Global_680
...
MultiTrappingGlobal680 = make_fragment_scan_exp(MultiTrappingGlobal680Frag)
