...
class NestedSpectroscopyRF691Frag(ExpFragment):
    """Nested Experiment Nested_Spectroscopy_RF_691
...
NestedSpectroscopyRF691 = make_fragment_scan_exp(NestedSpectroscopyRF691Frag)
