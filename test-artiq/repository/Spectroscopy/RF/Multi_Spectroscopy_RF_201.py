...
class MultiSpectroscopyRF201Frag(ExpFragment):
    """Multi-channel Experiment Multi_Spectroscopy_RF_201
...
MultiSpectroscopyRF201 = make_fragment_scan_exp(MultiSpectroscopyRF201Frag)
