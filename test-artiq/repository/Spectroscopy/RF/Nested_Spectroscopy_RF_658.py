...
class NestedSpectroscopyRF658Frag(ExpFragment):
    """Nested Experiment Nested_Spectroscopy_RF_658
...
NestedSpectroscopyRF658 = make_fragment_scan_exp(NestedSpectroscopyRF658Frag)
