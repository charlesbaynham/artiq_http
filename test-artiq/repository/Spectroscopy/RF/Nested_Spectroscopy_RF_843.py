...
class NestedSpectroscopyRF843Frag(ExpFragment):
    """Nested Experiment Nested_Spectroscopy_RF_843
...
NestedSpectroscopyRF843 = make_fragment_scan_exp(NestedSpectroscopyRF843Frag)
