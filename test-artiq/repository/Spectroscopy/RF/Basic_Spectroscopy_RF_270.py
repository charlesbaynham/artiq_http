...
class BasicSpectroscopyRF270Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Spectroscopy_RF_270
...
BasicSpectroscopyRF270 = make_fragment_scan_exp(BasicSpectroscopyRF270Frag)
