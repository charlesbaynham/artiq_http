...
class NestedSpectroscopyRF776Frag(ExpFragment):
    """Nested Experiment Nested_Spectroscopy_RF_776
...
NestedSpectroscopyRF776 = make_fragment_scan_exp(NestedSpectroscopyRF776Frag)
