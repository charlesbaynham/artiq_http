...
class BasicSpectroscopyGlobal939Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Spectroscopy_Global_939
...
BasicSpectroscopyGlobal939 = make_fragment_scan_exp(BasicSpectroscopyGlobal939Frag)
