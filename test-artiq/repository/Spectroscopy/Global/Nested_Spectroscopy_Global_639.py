...
class NestedSpectroscopyGlobal639Frag(ExpFragment):
    """Nested Experiment Nested_Spectroscopy_Global_639
...
NestedSpectroscopyGlobal639 = make_fragment_scan_exp(NestedSpectroscopyGlobal639Frag)
