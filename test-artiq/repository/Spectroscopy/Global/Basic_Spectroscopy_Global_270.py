...
class BasicSpectroscopyGlobal270Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Spectroscopy_Global_270
...
BasicSpectroscopyGlobal270 = make_fragment_scan_exp(BasicSpectroscopyGlobal270Frag)
