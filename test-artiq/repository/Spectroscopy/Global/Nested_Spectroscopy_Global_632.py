...
class NestedSpectroscopyGlobal632Frag(ExpFragment):
    """Nested Experiment Nested_Spectroscopy_Global_632
...
NestedSpectroscopyGlobal632 = make_fragment_scan_exp(NestedSpectroscopyGlobal632Frag)
