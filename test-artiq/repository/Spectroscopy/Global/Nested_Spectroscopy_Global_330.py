...
class NestedSpectroscopyGlobal330Frag(ExpFragment):
    """Nested Experiment Nested_Spectroscopy_Global_330
...
NestedSpectroscopyGlobal330 = make_fragment_scan_exp(NestedSpectroscopyGlobal330Frag)
