...
class BasicSpectroscopyOptical624Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Spectroscopy_Optical_624
...
BasicSpectroscopyOptical624 = make_fragment_scan_exp(BasicSpectroscopyOptical624Frag)
