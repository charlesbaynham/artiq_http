...
class MultiSpectroscopyOptical617Frag(ExpFragment):
    """Multi-channel Experiment Multi_Spectroscopy_Optical_617
...
MultiSpectroscopyOptical617 = make_fragment_scan_exp(MultiSpectroscopyOptical617Frag)
