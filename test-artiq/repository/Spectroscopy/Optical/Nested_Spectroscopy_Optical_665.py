...
class NestedSpectroscopyOptical665Frag(ExpFragment):
    """Nested Experiment Nested_Spectroscopy_Optical_665
...
NestedSpectroscopyOptical665 = make_fragment_scan_exp(NestedSpectroscopyOptical665Frag)
