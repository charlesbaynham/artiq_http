...
class MultiSpectroscopyOptical689Frag(ExpFragment):
    """Multi-channel Experiment Multi_Spectroscopy_Optical_689
...
MultiSpectroscopyOptical689 = make_fragment_scan_exp(MultiSpectroscopyOptical689Frag)
