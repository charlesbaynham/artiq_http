...
class BasicSpectroscopyOptical674Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Spectroscopy_Optical_674
...
BasicSpectroscopyOptical674 = make_fragment_scan_exp(BasicSpectroscopyOptical674Frag)
