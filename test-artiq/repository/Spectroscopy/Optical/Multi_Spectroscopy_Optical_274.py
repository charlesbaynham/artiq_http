...
class MultiSpectroscopyOptical274Frag(ExpFragment):
    """Multi-channel Experiment Multi_Spectroscopy_Optical_274
...
MultiSpectroscopyOptical274 = make_fragment_scan_exp(MultiSpectroscopyOptical274Frag)
