...
class MultiSpectroscopyLaser672Frag(ExpFragment):
    """Multi-channel Experiment Multi_Spectroscopy_Laser_672
...
MultiSpectroscopyLaser672 = make_fragment_scan_exp(MultiSpectroscopyLaser672Frag)
