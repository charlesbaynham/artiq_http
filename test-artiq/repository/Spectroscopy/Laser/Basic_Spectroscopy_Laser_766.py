...
class BasicSpectroscopyLaser766Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Spectroscopy_Laser_766
...
BasicSpectroscopyLaser766 = make_fragment_scan_exp(BasicSpectroscopyLaser766Frag)
