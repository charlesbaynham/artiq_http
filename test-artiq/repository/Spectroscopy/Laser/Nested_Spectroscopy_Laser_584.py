...
class NestedSpectroscopyLaser584Frag(ExpFragment):
    """Nested Experiment Nested_Spectroscopy_Laser_584
...
NestedSpectroscopyLaser584 = make_fragment_scan_exp(NestedSpectroscopyLaser584Frag)
