...
class NestedSpectroscopyLaser811Frag(ExpFragment):
    """Nested Experiment Nested_Spectroscopy_Laser_811
...
NestedSpectroscopyLaser811 = make_fragment_scan_exp(NestedSpectroscopyLaser811Frag)
