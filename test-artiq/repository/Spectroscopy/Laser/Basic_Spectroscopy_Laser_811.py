...
class BasicSpectroscopyLaser811Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Spectroscopy_Laser_811
...
BasicSpectroscopyLaser811 = make_fragment_scan_exp(BasicSpectroscopyLaser811Frag)
