...
class BasicSpectroscopyMagnetic392Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Spectroscopy_Magnetic_392
...
BasicSpectroscopyMagnetic392 = make_fragment_scan_exp(BasicSpectroscopyMagnetic392Frag)
