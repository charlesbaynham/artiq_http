...
class NestedSpectroscopyMagnetic489Frag(ExpFragment):
    """Nested Experiment Nested_Spectroscopy_Magnetic_489
...
NestedSpectroscopyMagnetic489 = make_fragment_scan_exp(NestedSpectroscopyMagnetic489Frag)
