...
class NestedSpectroscopyMagnetic625Frag(ExpFragment):
    """Nested Experiment Nested_Spectroscopy_Magnetic_625
...
NestedSpectroscopyMagnetic625 = make_fragment_scan_exp(NestedSpectroscopyMagnetic625Frag)
