...
class MultiSpectroscopyMagnetic602Frag(ExpFragment):
    """Multi-channel Experiment Multi_Spectroscopy_Magnetic_602
...
MultiSpectroscopyMagnetic602 = make_fragment_scan_exp(MultiSpectroscopyMagnetic602Frag)
