...
class BasicCalibrationRF235Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Calibration_RF_235
...
BasicCalibrationRF235 = make_fragment_scan_exp(BasicCalibrationRF235Frag)
