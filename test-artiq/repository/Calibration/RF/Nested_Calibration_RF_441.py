...
class NestedCalibrationRF441Frag(ExpFragment):
    """Nested Experiment Nested_Calibration_RF_441
...
NestedCalibrationRF441 = make_fragment_scan_exp(NestedCalibrationRF441Frag)
