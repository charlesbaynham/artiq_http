...
class NestedCalibrationRF118Frag(ExpFragment):
    """Nested Experiment Nested_Calibration_RF_118
...
NestedCalibrationRF118 = make_fragment_scan_exp(NestedCalibrationRF118Frag)
