...
class MultiCalibrationLaser417Frag(ExpFragment):
    """Multi-channel Experiment Multi_Calibration_Laser_417
...
MultiCalibrationLaser417 = make_fragment_scan_exp(MultiCalibrationLaser417Frag)
