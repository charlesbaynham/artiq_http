...
class BasicCalibrationLaser396Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Calibration_Laser_396
...
BasicCalibrationLaser396 = make_fragment_scan_exp(BasicCalibrationLaser396Frag)
