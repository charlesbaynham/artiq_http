...
class MultiCalibrationLaser833Frag(ExpFragment):
    """Multi-channel Experiment Multi_Calibration_Laser_833
...
MultiCalibrationLaser833 = make_fragment_scan_exp(MultiCalibrationLaser833Frag)
