...
class NestedCalibrationLaser926Frag(ExpFragment):
    """Nested Experiment Nested_Calibration_Laser_926
...
NestedCalibrationLaser926 = make_fragment_scan_exp(NestedCalibrationLaser926Frag)
