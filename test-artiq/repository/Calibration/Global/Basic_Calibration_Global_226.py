...
class BasicCalibrationGlobal226Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Calibration_Global_226
...
BasicCalibrationGlobal226 = make_fragment_scan_exp(BasicCalibrationGlobal226Frag)
