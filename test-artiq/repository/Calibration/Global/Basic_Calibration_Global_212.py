...
class BasicCalibrationGlobal212Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Calibration_Global_212
...
BasicCalibrationGlobal212 = make_fragment_scan_exp(BasicCalibrationGlobal212Frag)
