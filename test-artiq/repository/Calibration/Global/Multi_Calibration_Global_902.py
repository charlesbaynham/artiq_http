...
class MultiCalibrationGlobal902Frag(ExpFragment):
    """Multi-channel Experiment Multi_Calibration_Global_902
...
MultiCalibrationGlobal902 = make_fragment_scan_exp(MultiCalibrationGlobal902Frag)
