...
class NestedCalibrationGlobal977Frag(ExpFragment):
    """Nested Experiment Nested_Calibration_Global_977
...
NestedCalibrationGlobal977 = make_fragment_scan_exp(NestedCalibrationGlobal977Frag)
