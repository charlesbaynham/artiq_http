...
class MultiCalibrationOptical653Frag(ExpFragment):
    """Multi-channel Experiment Multi_Calibration_Optical_653
...
MultiCalibrationOptical653 = make_fragment_scan_exp(MultiCalibrationOptical653Frag)
