...
class MultiCalibrationOptical426Frag(ExpFragment):
    """Multi-channel Experiment Multi_Calibration_Optical_426
...
MultiCalibrationOptical426 = make_fragment_scan_exp(MultiCalibrationOptical426Frag)
