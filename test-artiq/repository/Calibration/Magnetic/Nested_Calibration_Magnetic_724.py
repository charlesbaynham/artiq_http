...
class NestedCalibrationMagnetic724Frag(ExpFragment):
    """Nested Experiment Nested_Calibration_Magnetic_724
...
NestedCalibrationMagnetic724 = make_fragment_scan_exp(NestedCalibrationMagnetic724Frag)
