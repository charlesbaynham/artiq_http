...
class NestedCalibrationMagnetic446Frag(ExpFragment):
    """Nested Experiment Nested_Calibration_Magnetic_446
...
NestedCalibrationMagnetic446 = make_fragment_scan_exp(NestedCalibrationMagnetic446Frag)
