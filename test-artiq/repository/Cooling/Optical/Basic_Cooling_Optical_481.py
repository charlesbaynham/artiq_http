...
class BasicCoolingOptical481Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Cooling_Optical_481
...
BasicCoolingOptical481 = make_fragment_scan_exp(BasicCoolingOptical481Frag)
