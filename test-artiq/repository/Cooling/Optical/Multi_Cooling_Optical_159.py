...
class MultiCoolingOptical159Frag(ExpFragment):
    """Multi-channel Experiment Multi_Cooling_Optical_159
...
MultiCoolingOptical159 = make_fragment_scan_exp(MultiCoolingOptical159Frag)
