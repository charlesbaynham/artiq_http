...
class MultiCoolingOptical962Frag(ExpFragment):
    """Multi-channel Experiment Multi_Cooling_Optical_962
...
MultiCoolingOptical962 = make_fragment_scan_exp(MultiCoolingOptical962Frag)
