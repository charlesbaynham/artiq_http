...
class BasicCoolingOptical887Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Cooling_Optical_887
...
BasicCoolingOptical887 = make_fragment_scan_exp(BasicCoolingOptical887Frag)
