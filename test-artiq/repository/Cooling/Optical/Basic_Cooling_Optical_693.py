...
class BasicCoolingOptical693Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Cooling_Optical_693
...
BasicCoolingOptical693 = make_fragment_scan_exp(BasicCoolingOptical693Frag)
