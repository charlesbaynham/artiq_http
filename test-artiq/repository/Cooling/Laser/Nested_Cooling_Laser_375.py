...
class NestedCoolingLaser375Frag(ExpFragment):
    """Nested Experiment Nested_Cooling_Laser_375
...
NestedCoolingLaser375 = make_fragment_scan_exp(NestedCoolingLaser375Frag)
