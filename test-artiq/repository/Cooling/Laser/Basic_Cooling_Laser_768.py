...
class BasicCoolingLaser768Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Cooling_Laser_768
...
BasicCoolingLaser768 = make_fragment_scan_exp(BasicCoolingLaser768Frag)
