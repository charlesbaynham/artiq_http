...
class MultiCoolingLaser407Frag(ExpFragment):
    """Multi-channel Experiment Multi_Cooling_Laser_407
...
MultiCoolingLaser407 = make_fragment_scan_exp(MultiCoolingLaser407Frag)
