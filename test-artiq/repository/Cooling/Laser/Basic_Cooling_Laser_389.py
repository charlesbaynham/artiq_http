...
class BasicCoolingLaser389Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Cooling_Laser_389
...
BasicCoolingLaser389 = make_fragment_scan_exp(BasicCoolingLaser389Frag)
