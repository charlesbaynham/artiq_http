...
class BasicCoolingGlobal951Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Cooling_Global_951
...
BasicCoolingGlobal951 = make_fragment_scan_exp(BasicCoolingGlobal951Frag)
