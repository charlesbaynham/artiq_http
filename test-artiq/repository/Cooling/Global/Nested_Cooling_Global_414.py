...
class NestedCoolingGlobal414Frag(ExpFragment):
    """Nested Experiment Nested_Cooling_Global_414
...
NestedCoolingGlobal414 = make_fragment_scan_exp(NestedCoolingGlobal414Frag)
