...
class BasicCoolingGlobal713Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Cooling_Global_713
...
BasicCoolingGlobal713 = make_fragment_scan_exp(BasicCoolingGlobal713Frag)
