...
class NestedCoolingGlobal407Frag(ExpFragment):
    """Nested Experiment Nested_Cooling_Global_407
...
NestedCoolingGlobal407 = make_fragment_scan_exp(NestedCoolingGlobal407Frag)
