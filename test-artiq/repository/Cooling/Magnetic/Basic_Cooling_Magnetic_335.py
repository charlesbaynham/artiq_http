...
class BasicCoolingMagnetic335Frag(ExpFragment):
    """Basic NDScan Experiment Basic_Cooling_Magnetic_335
...
BasicCoolingMagnetic335 = make_fragment_scan_exp(BasicCoolingMagnetic335Frag)
