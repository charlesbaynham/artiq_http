...
class MultiCoolingMagnetic583Frag(ExpFragment):
    """Multi-channel Experiment Multi_Cooling_Magnetic_583
...
MultiCoolingMagnetic583 = make_fragment_scan_exp(MultiCoolingMagnetic583Frag)
