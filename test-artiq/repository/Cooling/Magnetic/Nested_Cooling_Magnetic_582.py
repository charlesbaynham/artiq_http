...
class NestedCoolingMagnetic582Frag(ExpFragment):
    """Nested Experiment Nested_Cooling_Magnetic_582
...
NestedCoolingMagnetic582 = make_fragment_scan_exp(NestedCoolingMagnetic582Frag)
