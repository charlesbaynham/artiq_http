...
class NestedCoolingMagnetic442Frag(ExpFragment):
    """Nested Experiment Nested_Cooling_Magnetic_442
...
NestedCoolingMagnetic442 = make_fragment_scan_exp(NestedCoolingMagnetic442Frag)
