 ...
 */ (function (e) {
  ...
  function r(_) {
    ...
    if (b !== I) {
      _[0] = b;
      e: for (var z = 0, V = _.length, T = V >>> 1; z < T; ) {
        var F = 2 * (z + 1) - 1,
          K = _[F],
          Y = F + 1,
          J = _[Y];
        if (0 > o(K, b))
          Y < V && 0 > o(J, K)
            ? ((_[z] = J), (_[Y] = b), (z = Y))
            : ((_[z] = K), (_[F] = b), (z = F));
        else if (Y < V && 0 > o(J, b)) (_[z] = J), (_[Y] = b), (z = Y);
        else break e;
      }
    }
    return I;
  ...
  if (!!S) {
    if (l) {
      var Q,
        ...
        J = K[M],
        se = wo(0, N[W], F[W]),
        te = g ? N[W] / 2 - b - se - Y - D.mainAxis : z - se - Y - D.mainAxis,
        ...
        H = (Q = A == null ? void 0 : A[w]) != null ? Q : 0,
        ne = q + te - H - B,
        ie = q + ue - H,
    ...
    if (i) {
      var fe,
        ...
        le = (fe = A == null ? void 0 : A[C]) != null ? fe : 0,
...
function kc({
  ...
  return (
    ...
    Q.indexOf("hover") !== -1 && ((P.onMouseOver = A), (P.onMouseOut = G)),
    $.exports.jsxs($.exports.Fragment, {
      children: [
      ...
      r.length === 0
        ...
        : r.map((C, S) => {
            ...
            const N = C.fqn ? t[C.fqn] : null,
              ...
              A = Dt((M = C.range) == null ? void 0 : M.stop, j);
            return s.createElement(
              nt,
                          ...
                          s.createElement(
                            ot,
                            {
                              ...
                              variant: z.has(T)
                                ...
                                : "outline-primary",
                              onClick: (K) => {
                                K.stopPropagation(), z.has(T) ? j(T) : O(T);
                              },
      ...
      s.createElement(
        ...
        o.map((P, M) => {
          ...
          const q = P.xs || e,
            _ = W.map((I, b) => {
              const z = q[b];
              return !isFinite(I) || !isFinite(z) ? null : `${C(z)},${S(I)}`;
            })
              .filter(Boolean)
              .join(" ");
...
function _v({ xs: e, ys: t, values: n, xLabel: r, yLabel: o, metric: l }) {
  ...
  const {
      ...
      const b = [...new Set(e)].sort((te, ue) => te - ue),
        z = [...new Set(t)].sort((te, ue) => te - ue),
        V = b.length,
        T = z.length,
        F = new Map(b.map((te, ue) => [te, ue])),
        K = new Map(z.map((te, ue) => [te, ue])),
  ...
  if (
    (m.exports.useEffect(() => {
      ...
      (b.width = Math.max(1, S) * z),
        (b.height = Math.max(1, N) * z),
        (b.style.width = S + "px"),
        (b.style.height = N + "px");
...
async function Fk({
  ...
  if (n === "1D" || n === "2D" || w) {
    ...
    const A = r.filter((_) => _.on),
      G = Math.max(1, Math.ceil(Math.sqrt(A.length || 1))),
      Q = Math.ceil((A.length || 1) / G),
      P = 200,
      M = 110,
      W = 12,
      q = 12;
...
function Hk() {
  ...
  const D = m.exports.useCallback(
    ...
    [A, G] = m.exports.useState(null);
  m.exports.useEffect(() => {
    g === "2D" && N.length && !N.includes(A) && G(N[0]);
  }, [g, N, A]);
  ...
  const T = m.exports.useCallback((B) => {
      V((H) => (H.includes(B) ? H.filter((ne) => ne !== B) : [...H, B]));
    }, []),
    [F, K] = m.exports.useState({});
  m.exports.useEffect(() => {
    K((B) => (Object.keys(B).length === 0 ? B : {}));
  }, [h]);
  const Y = z.join(" ");
  m.exports.useEffect(() => {
  ...
  const J = m.exports.useMemo(
      () =>
        g !== "1D"
          ? []
          : z.map((B) => F[B]).filter((B) => B && B.values && B.values.length),
      [z, F, g],
    ),
...
const bc = m.exports.forwardRef(
  (
    ...
    const B = () => {
      ...
      H = (le) => {
        b.current && T && le.target === T.dialog && (z.current = !0),
          (b.current = !1);
      },
      ne = () => {
        I(!0),
      ...
      de = (le) => {
        ...
        if (z.current || le.target !== le.currentTarget) {
          z.current = !1;
          return;
        }
        k == null || k();
