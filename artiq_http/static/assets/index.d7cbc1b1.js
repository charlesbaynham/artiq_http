...
oe.StrictMode = Fv;
oe.Suspense = Vv;
oe.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Xv;
oe.cloneElement = function (e, t, n) {
  ...
  if (t != null) {
    if (
      (t.ref !== void 0 && ((l = t.ref), (a = Yi.current)),
...
oe.isValidElement = Xi;
oe.lazy = function (e) {
  return { $$typeof: Kv, _payload: { _status: -1, _result: e }, _init: Yv };
};
...
const s = yd(p.exports),
  Jv = Dv({ __proto__: null, default: s }, [p.exports]);
var Ji = { exports: {} },
  ut = {},
  Rd = { exports: {} },
  Od = {};
 ...
 */ (function (e) {
  ...
  function r(_) {
    ...
    if (L !== z) {
      _[0] = L;
      e: for (var A = 0, W = _.length, P = W >>> 1; A < P; ) {
        var U = 2 * (A + 1) - 1,
          H = _[U],
          Q = U + 1,
          J = _[Q];
        if (0 > o(H, L))
          Q < W && 0 > o(J, H)
            ? ((_[A] = J), (_[Q] = L), (A = Q))
            : ((_[A] = H), (_[U] = L), (A = U));
        else if (Q < W && 0 > o(J, L)) (_[A] = J), (_[Q] = L), (A = Q);
        else break e;
      }
    }
    return z;
  ...
  function E(_) {
    if (((w = !1), g(_), !x))
      if (n(u) !== null) (x = !0), V(S);
        ...
        var z = n(c);
        z !== null && Y(E, z.startTime - _);
      }
  }
  function S(_, z) {
    (x = !1), w && ((w = !1), m(R), (R = -1)), (y = !0);
    var L = v;
    try {
      for (
        g(z), d = n(u);
        d !== null && (!(d.expirationTime > z) || (_ && !I()));

      ) {
        var A = d.callback;
        if (typeof A == "function") {
          (d.callback = null), (v = d.priorityLevel);
          var W = A(d.expirationTime <= z);
          (z = e.unstable_now()),
            typeof W == "function" ? (d.callback = W) : d === n(u) && r(u),
            g(z);
        } else r(u);
        d = n(u);
      }
      ...
      return (
        ...
        L > A
          ? ((_.sortIndex = L),
            ...
            n(u) === null &&
              _ === n(c) &&
              (w ? (m(R), (R = -1)) : (w = !0), Y(E, L - A)))
          : ((_.sortIndex = W), t(u, _), x || y || ((x = !0), V(S))),
        _
      );
    }),
...
function Rr(e, t) {
  for (So[e] = t, e = 0; e < t.length; e++) Pd.add(t[e]);
}
var Yt = !(
    typeof window > "u" ||
...
function Bc(e) {
  if ((e = Qo(e))) {
    if (typeof Bs != "function") throw Error(M(280));
    var t = e.stateNode;
    t && ((t = Oa(t)), Bs(e.stateNode, e.type, t));
  }
}
function Bd(e) {
...
function Wd() {
  if (Er) {
    var e = Er,
      t = wr;
    if (((wr = Er = null), Bc(e), t)) for (e = 0; e < t.length; e++) Bc(t[e]);
  }
}
function Ud(e, t) {
  return e(t);
...
function cg(e, t, n, r, o, l, a, i, u) {
  (uo = !1), (Ul = null), ig.apply(ug, arguments);
}
function fg(e, t, n, r, o, l, a, i, u) {
  if ((cg.apply(this, arguments), uo)) {
    if (uo) {
      var c = Ul;
      (uo = !1), (Ul = null);
...
function dg(e) {
  ...
  for (var n = e, r = t; ; ) {
    ...
    if (o.child === l.child) {
      for (l = o.child; l; ) {
        if (l === n) return Wc(o), e;
        if (l === r) return Wc(o), t;
        l = l.sibling;
      }
      throw Error(M(188));
    }
...
var qd = it.unstable_scheduleCallback,
  Uc = it.unstable_cancelCallback,
  pg = it.unstable_shouldYield,
  mg = it.unstable_requestPaint,
  Se = it.unstable_now,
  hg = it.unstable_getCurrentPriorityLevel,
  au = it.unstable_ImmediatePriority,
  Yd = it.unstable_UserBlockingPriority,
  Hl = it.unstable_NormalPriority,
  vg = it.unstable_LowPriority,
  Xd = it.unstable_IdlePriority,
  ka = null,
  It = null;
function gg(e) {
...
var _t = Math.clz32 ? Math.clz32 : Eg,
  yg = Math.log,
  xg = Math.LN2;
function Eg(e) {
...
function Kl(e, t) {
  ...
  if (a !== 0) {
    var i = a & ~o;
    i !== 0 ? (r = lo(i)) : ((l &= a), l !== 0 && (r = lo(l)));
  } else (a = n & ~o), a !== 0 ? (r = lo(a)) : l !== 0 && (r = lo(l));
  if (r === 0) return 0;
  if (
    t !== 0 &&
    t !== r &&
...
function Ng(e, t, n, r, o) {
  switch (t) {
    case "focusin":
      return (wn = Gr(wn, e, t, n, r, o)), !0;
    case "dragenter":
      return (Sn = Gr(Sn, e, t, n, r, o)), !0;
    case "mouseover":
      return (kn = Gr(kn, e, t, n, r, o)), !0;
    case "pointerover":
      var l = o.pointerId;
      return No.set(l, Gr(No.get(l) || null, e, t, n, r, o)), !0;
    case "gotpointercapture":
      return (
        (l = o.pointerId), Ro.set(l, Gr(Ro.get(l) || null, e, t, n, r, o)), !0
      );
  }
  return !1;
}
...
function _l(e) {
  ...
  for (var t = e.targetContainers; 0 < t.length; ) {
    ...
    } else return (t = Qo(n)), t !== null && iu(t), (e.blockedOn = n), !1;
    t.shift();
  }
  return !0;
}
...
function qr(e, t) {
  e.blockedOn === t &&
    ...
    Hs ||
      ((Hs = !0),
      it.unstable_scheduleCallback(it.unstable_NormalPriority, Rg)));
}
function Oo(e) {
  function t(o) {
    return qr(o, e);
  ...
  for (; 0 < vn.length && ((n = vn[0]), n.blockedOn === null); )
    op(n), n.blockedOn === null && vn.shift();
}
...
function uu(e, t, n, r) {
  if (Ql) {
    var o = Ks(e, t, n, r);
    if (o === null) is(e, t, r, Gl, n), Vc(e, r);
...
var Gl = null;
function Ks(e, t, n, r) {
  if (((Gl = null), (e = lu(r)), (e = An(e)), e !== null))
...
var zr = {
  ...
  Ca = xe({}, Ko, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== Yr &&
            (Yr && e.type === "mousemove"
              ? ((Za = e.screenX - Yr.screenX), (es = e.screenY - Yr.screenY))
              : (es = Za = 0),
            (Yr = e)),
          Za);
    },
  ...
  Qc = ct(Ca),
  Tg = xe({}, Ca, { dataTransfer: 0 }),
  bg = ct(Tg),
  $g = xe({}, Ko, { relatedTarget: 0 }),
  ts = ct($g),
  Lg = xe({}, zr, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  jg = ct(Lg),
  Mg = xe({}, zr, {
...
var Wg = xe({}, Ko, {
  ...
  Kg = ct(Hg),
  Qg = xe({}, zr, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Gg = ct(Qg),
  qg = xe({}, Ca, {
    deltaX: function (e) {
  ...
  co = null;
Yt && "documentMode" in document && (co = document.documentMode);
var Jg = Yt && "TextEvent" in window && !co,
  sp = Yt && (!pu || (co && 8 < co && 11 >= co)),
...
function e0(e, t) {
  if (ur)
    return e === "compositionend" || (!pu && ip(e, t))
      ? ((e = ap()), (Pl = cu = xn = null), (ur = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
  ...
  if (Yt) {
    ...
    if (!rs) {
      ...
      Zc.setAttribute("oninput", "return;"),
        (rs = typeof Zc.oninput == "function");
    }
    ns = rs;
  } else ns = !1;
  fp = ns && (!document.documentMode || 9 < document.documentMode);
}
function ef() {
  fo && (fo.detachEvent("onpropertychange", dp), (_o = fo = null));
}
function dp(e) {
  if (e.propertyName === "value" && Na(_o)) {
    var t = [];
    cp(t, _o, e, lu(e)), Hd(n0, t);
  }
}
function o0(e, t, n) {
  e === "focusin"
    ? (ef(), (fo = t), (_o = n), fo.attachEvent("onpropertychange", dp))
    : e === "focusout" && ef();
}
function l0(e) {
...
var Tt = typeof Object.is == "function" ? Object.is : i0;
function Po(e, t) {
  if (Tt(e, t)) return !0;
  ...
  for (r = 0; r < n.length; r++) {
    var o = n[r];
    if (!_s.call(t, o) || !Tt(e[o], t[o])) return !1;
  }
  return !0;
}
function tf(e) {
...
function Ra(e) {
  ...
  var t = fr[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in hp) return (os[e] = t[n]);
  return e;
}
var vp = Ra("animationend"),
  gp = Ra("animationiteration"),
  yp = Ra("animationstart"),
  xp = Ra("transitionend"),
  Ep = new Map(),
  of =
...
for (var ls = 0; ls < of.length; ls++) {
  var as = of[ls],
    f0 = as.toLowerCase(),
    d0 = as[0].toUpperCase() + as.slice(1);
  $n(f0, "on" + d0);
}
$n(vp, "onAnimationEnd");
$n(gp, "onAnimationIteration");
$n(yp, "onAnimationStart");
$n("dblclick", "onDoubleClick");
$n("focusin", "onFocus");
$n("focusout", "onBlur");
$n(xp, "onTransitionEnd");
...
var ao =
  ...
  p0 = new Set("cancel close invalid load scroll toggle".split(" ").concat(ao));
function lf(e, t, n) {
...
function wp(e, t) {
  ...
  if (Vl) throw ((e = Us), (Vl = !1), (Us = null), e);
}
function pe(e, t) {
  var n = t[Zs];
  ...
  if (!e[pl]) {
    (e[pl] = !0),
      Pd.forEach(function (n) {
        n !== "selectionchange" && (p0.has(n) || ss(n, !1, e), ss(n, !0, e));
      });
    var t = e.nodeType === 9 ? e : e.ownerDocument;
    t === null || t[pl] || ((t[pl] = !0), ss("selectionchange", !1, t));
  }
}
function Sp(e, t, n, r) {
  switch (lp(t)) {
...
function is(e, t, n, r, o) {
  ...
  Hd(function () {
        ...
        for (var h = c, g; h !== null; ) {
          ...
          if (
            (g.tag === 5 &&
              E !== null &&
              ((g = E),
              m !== null && ((E = Co(h, m)), E != null && w.push(bo(h, E, g)))),
            k)
          )
            break;
          h = h.return;
    ...
    if ((t & 7) === 0) {
      e: {
        ...
        if (
          ...
          if (
            ...
            (k = y == null ? v : dr(y)),
            (g = x == null ? v : dr(x)),
            (v = new w(E, h + "leave", y, n, f)),
            (v.target = k),
            (v.relatedTarget = g),
            (E = null),
            An(f) === c &&
              ((w = new w(m, h + "enter", x, n, f)),
              (w.target = g),
              (w.relatedTarget = k),
              (E = w)),
            (k = E),
            ...
            t: {
              for (w = y, m = x, h = 0, g = w; g; g = tr(g)) h++;
              for (g = 0, E = m; E; E = tr(E)) g++;
              for (; 0 < h - g; ) (w = tr(w)), h--;
              for (; 0 < g - h; ) (m = tr(m)), g--;
              for (; h--; ) {
      ...
      switch (((N = c ? dr(c) : window), e)) {
        case "focusin":
          (Jc(N) || N.contentEditable === "true") &&
            ((cr = N), (Qs = c), (po = null));
          break;
        case "focusout":
          po = Qs = cr = null;
      ...
      if (pu)
        ...
        ur
          ? ip(e, n) && (R = "onCompositionEnd")
          : e === "keydown" && n.keyCode === 229 && (R = "onCompositionStart");
      R &&
        (sp &&
          n.locale !== "ko" &&
          (ur || R !== "onCompositionStart"
            ? R === "onCompositionEnd" && ur && (C = ap())
            : ((xn = f),
              (cu = "value" in xn ? xn.value : xn.textContent),
              (ur = !0))),
        (N = ql(c, R)),
        0 < N.length &&
          ((R = new Gc(R, e, null, n, f)),
          d.push({ event: R, listeners: N }),
          C ? (R.data = C) : ((C = up(n)), C !== null && (R.data = C)))),
        (C = Jg ? Zg(e, n) : e0(e, n)) &&
          ((c = ql(c, "onBeforeInput")),
          0 < c.length &&
            ((f = new Gc("onBeforeInput", "beforeinput", null, n, f)),
...
function af(e, t, n, r, o) {
  for (var l = t._reactName, a = []; n !== null && n !== r; ) {
    ...
    i.tag === 5 &&
      ...
      ((i = c),
      o
        ? ((u = Co(n, l)), u != null && a.unshift(bo(n, u, i)))
        : o || ((u = Co(n, l)), u != null && a.push(bo(n, u, i)))),
      (n = n.return);
  }
...
function ml(e, t, n) {
  if (((t = sf(t)), sf(e) !== t && n)) throw Error(M(425));
}
function Yl() {}
var qs = null,
  Ys = null;
...
var Js = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  g0 =
    typeof queueMicrotask == "function"
      ...
      : typeof uf < "u"
        ? function (e) {
            return uf.resolve(null).then(e).catch(y0);
          }
        : Js;
function y0(e) {
  setTimeout(function () {
...
var Fr = Math.random().toString(36).slice(2),
  Mt = "__reactFiber$" + Fr,
  $o = "__reactProps$" + Fr,
  Xt = "__reactContainer$" + Fr,
  Zs = "__reactEvents$" + Fr,
  x0 = "__reactListeners$" + Fr,
  E0 = "__reactHandles$" + Fr;
function An(e) {
  var t = e[Mt];
  if (t) return t;
...
function ff(e, t, n) {
  if (Ae.current !== Tn) throw Error(M(168));
  de(Ae, t), de(Je, n);
}
function kp(e, t, n) {
  var r = e.stateNode;
  if (((t = t.childContextTypes), typeof r.getChildContext != "function"))
    return n;
  r = r.getChildContext();
  for (var o in r) if (!(o in t)) throw Error(M(108, og(e) || "Unknown", o));
  return xe({}, n, r);
}
function Jl(e) {
  return (
...
function jn() {
  if (!cs && Ut !== null) {
    ...
    try {
      ...
      throw (Ut !== null && (Ut = Ut.slice(e + 1)), qd(au, jn), o);
    } finally {
      (ue = t), (cs = !1);
    }
  }
...
function Np(e, t, n) {
  (dt[pt++] = Vt), (dt[pt++] = Ht), (dt[pt++] = Gn), (Gn = e);
  var r = Vt;
  e = Ht;
  var o = 32 - _t(r) - 1;
  (r &= ~(1 << o)), (n += 1);
      ...
      return (
        (t =
          t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase()
            ...
            : t),
        t !== null
          ? ((e.stateNode = t), (st = e), (lt = Cn(t.firstChild)), !0)
          : !1
      );
    case 6:
      return (
        (t = e.pendingProps === "" || t.nodeType !== 3 ? null : t),
        t !== null ? ((e.stateNode = t), (st = e), (lt = null), !0) : !1
      );
    case 13:
      return (
...
function hl(e) {
  ...
  } else lt = st ? Cn(e.stateNode.nextSibling) : null;
  return !0;
}
function Op() {
...
var S0 = rn.ReactCurrentBatchConfig;
function Nt(e, t) {
  if (e && e.defaultProps) {
...
function bp(e, t, n) {
  ...
  return (
    typeof l == "object" && l !== null
      ? (l = gt(l))
      : ((o = Ze(t) ? Qn : Ae.current),
        (r = t.contextTypes),
        (l = (r = r != null) ? Or(e, o) : Tn)),
    (t = new t(n, l)),
...
function li(e, t, n, r) {
  var o = e.stateNode;
  (o.props = n), (o.state = e.memoizedState), (o.refs = Tp), Su(e);
  var l = t.contextType;
  typeof l == "object" && l !== null
    ? (o.context = gt(l))
    : ((l = Ze(t) ? Qn : Ae.current), (o.context = Or(e, l))),
...
function $p(e) {
  ...
  function i(m, h, g, E) {
    return h === null || h.tag !== 6
      ? ((h = gs(g, m.mode, E)), (h.return = m), h)
      : ((h = o(h, g)), (h.return = m), h);
  }
  function u(m, h, g, E) {
    var S = g.type;
    return S === ir
      ? f(m, h, g.props.children, E, g.key)
      : h !== null &&
          (h.elementType === S ||
            (typeof S == "object" &&
              S !== null &&
              S.$$typeof === pn &&
              xf(S) === h.type))
        ? ((E = o(h, g.props)), (E.ref = Xr(m, h, g)), (E.return = m), E)
        : ((E = Il(g.type, g.key, g.props, null, m.mode, E)),
          (E.ref = Xr(m, h, g)),
          (E.return = m),
          E);
  }
  function c(m, h, g, E) {
    return h === null ||
      ...
      ? ((h = ys(g, m.mode, E)), (h.return = m), h)
      : ((h = o(h, g.children || [])), (h.return = m), h);
  }
  function f(m, h, g, E, S) {
    return h === null || h.tag !== 7
      ? ((h = Hn(g, m.mode, E, S)), (h.return = m), h)
      : ((h = o(h, g)), (h.return = m), h);
  }
  function d(m, h, g) {
    if ((typeof h == "string" && h !== "") || typeof h == "number")
      return (h = gs("" + h, m.mode, g)), (h.return = m), h;
    if (typeof h == "object" && h !== null) {
      switch (h.$$typeof) {
        case ll:
          return (
            (g = Il(h.type, h.key, h.props, null, m.mode, g)),
            (g.ref = Xr(m, null, h)),
            (g.return = m),
            g
          );
        case sr:
          return (h = ys(h, m.mode, g)), (h.return = m), h;
        case pn:
          var E = h._init;
          return d(m, E(h._payload), g);
      }
      if (oo(h) || Kr(h))
        return (h = Hn(h, m.mode, g, null)), (h.return = m), h;
      vl(m, h);
    }
    return null;
  }
  function v(m, h, g, E) {
    ...
    if ((typeof g == "string" && g !== "") || typeof g == "number")
      return S !== null ? null : i(m, h, "" + g, E);
    if (typeof g == "object" && g !== null) {
      switch (g.$$typeof) {
        case ll:
          return g.key === S ? u(m, h, g, E) : null;
        case sr:
          return g.key === S ? c(m, h, g, E) : null;
        case pn:
          return (S = g._init), v(m, h, S(g._payload), E);
      }
      if (oo(g) || Kr(g)) return S !== null ? null : f(m, h, g, E, null);
      vl(m, g);
    }
    return null;
  }
  function y(m, h, g, E, S) {
    if ((typeof E == "string" && E !== "") || typeof E == "number")
      return (m = m.get(g) || null), i(h, m, "" + E, S);
    if (typeof E == "object" && E !== null) {
      switch (E.$$typeof) {
        case ll:
          return (m = m.get(E.key === null ? g : E.key) || null), u(h, m, E, S);
        case sr:
          return (m = m.get(E.key === null ? g : E.key) || null), c(h, m, E, S);
        case pn:
          var N = E._init;
          return y(m, h, g, N(E._payload), S);
      }
      if (oo(E) || Kr(E)) return (m = m.get(g) || null), f(h, m, E, S, null);
      vl(h, E);
    }
    return null;
  }
  function x(m, h, g, E) {
    for (
      var S = null, N = null, C = h, R = (h = 0), $ = null;
      C !== null && R < g.length;
      R++
    ) {
      ...
      e && C && j.alternate === null && t(m, C),
        (h = l(j, h, R)),
        N === null ? (S = j) : (N.sibling = j),
        (N = j),
        (C = $);
    }
    if (R === g.length) return n(m, C), ve && zn(m, R), S;
    if (C === null) {
      for (; R < g.length; R++)
        (C = d(m, g[R], E)),
          C !== null &&
            ((h = l(C, h, R)), N === null ? (S = C) : (N.sibling = C), (N = C));
      return ve && zn(m, R), S;
    }
    for (C = r(m, C); R < g.length; R++)
      ($ = y(C, m, R, g[R], E)),
        $ !== null &&
  ...
  function w(m, h, g, E) {
    ...
    if (((g = S.call(g)), g == null)) throw Error(M(151));
    for (
      var N = (S = null), C = h, R = (h = 0), $ = null, j = g.next();
      C !== null && !j.done;
      R++, j = g.next()
    ) {
      C.index > R ? (($ = C), (C = null)) : ($ = C.sibling);
      var I = v(m, C, j.value, E);
      if (I === null) {
        C === null && (C = $);
        break;
      }
    ...
    if (j.done) return n(m, C), ve && zn(m, R), S;
    if (C === null) {
      for (; !j.done; R++, j = g.next())
        (j = d(m, j.value, E)),
          j !== null &&
            ((h = l(j, h, R)), N === null ? (S = j) : (N.sibling = j), (N = j));
      return ve && zn(m, R), S;
    }
    for (C = r(m, C); !j.done; R++, j = g.next())
      (j = y(C, m, R, j.value, E)),
        j !== null &&
          (e && j.alternate !== null && C.delete(j.key === null ? R : j.key),
          (h = l(j, h, R)),
          N === null ? (S = j) : (N.sibling = j),
          (N = j));
    return (
      ...
      switch (g.$$typeof) {
        case ll:
          e: {
            ...
            g.type === ir
              ? ((h = Hn(g.props.children, m.mode, E, g.key)),
                (h.return = m),
                (m = h))
              : ((E = Il(g.type, g.key, g.props, null, m.mode, E)),
                (E.ref = Xr(m, h, g)),
        ...
        case sr:
          e: {
            ...
            (h = ys(g, m.mode, E)), (h.return = m), (m = h);
          }
          return a(m);
        case pn:
          return (N = g._init), k(m, h, N(g._payload), E);
      }
      if (oo(g)) return x(m, h, g, E);
      if (Kr(g)) return w(m, h, g, E);
      vl(m, g);
    }
    return (typeof g == "string" && g !== "") || typeof g == "number"
      ? ((g = "" + g),
        h !== null && h.tag === 6
          ...
          : (n(m, h), (h = gs(g, m.mode, E)), (h.return = m), (m = h)),
        a(m))
      : n(m, h);
  }
  return k;
...
var Pr = $p(!0),
  ...
  jo = Ln(Go);
function Wn(e) {
  if (e === Go) throw Error(M(174));
  return e;
}
function ku(e, t) {
  switch ((de(jo, t), de(Lo, e), de(zt, Go), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
var $l = rn.ReactCurrentDispatcher,
  ds = rn.ReactCurrentBatchConfig,
  qn = 0,
  ye = null,
  Re = null,
  Pe = null,
...
function Ou(e, t, n, r, o, l) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    ($l.current = e === null || e.memoizedState === null ? O0 : _0),
    (e = n(r, o)),
    mo)
  ) {
    l = 0;
    do {
      if (((mo = !1), (Mo = 0), 25 <= l)) throw Error(M(301));
      (l += 1),
        (Pe = Re = null),
        (t.updateQueue = null),
        ($l.current = P0),
...
function ps(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    o = e;
    do (l = o.lane), (ye.lanes |= l), (Yn |= l), (o = o.next);
    while (o !== e);
...
function Dp(e, t) {
  ...
  if (
    ...
    (r = r.queue),
    Pu(Fp.bind(null, n, r, e), [e]),
    r.getSnapshot !== t || l || (Pe !== null && Pe.memoizedState.tag & 1))
  ) {
    if (
      ((n.flags |= 2048),
      Io(9, zp.bind(null, n, r, o, t), void 0, null),
      Te === null)
    )
      throw Error(M(349));
    (qn & 30) !== 0 || Ip(n, t, o);
...
function zp(e, t, n, r) {
  (t.value = n), (t.getSnapshot = r), Ap(t) && Bp(e);
}
function Fp(e, t, n) {
  return n(function () {
    Ap(t) && Bp(e);
...
function Ef(e) {
  ...
  return (
    ...
    (t.queue = e),
    (e = e.dispatch = R0.bind(null, ye, e)),
    [t.memoizedState, e]
  );
}
function Io(e, t, n, r) {
...
function Ta(e, t, n, r) {
  ...
  if (Re !== null) {
    ...
    if (((l = a.destroy), r !== null && Ru(r, a.deps))) {
      o.memoizedState = Io(t, n, l, r);
      return;
    }
  }
  (ye.flags |= e), (o.memoizedState = Io(1 | t, n, l, r));
}
function wf(e, t) {
...
function Kp(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), Ta(4, 4, Hp.bind(null, t, e), n)
  );
}
function Tu() {}
function Qp(e, t) {
...
function qp(e, t, n) {
  return (qn & 21) === 0
    ...
    : (Tt(n, t) || ((n = Jd()), (ye.lanes |= n), (Yn |= n), (e.baseState = !0)),
      t);
}
function C0(e, t) {
  var n = ue;
...
function R0(e, t, n) {
  ...
  if (Xp(e)) Jp(t, o);
    ...
    if (
      ...
      try {
        var a = t.lastRenderedState,
          i = l(a, n);
        if (((o.hasEagerState = !0), (o.eagerState = i), Tt(i, a))) {
          var u = t.interleaved;
          u === null
            ? ((o.next = o), wu(t))
    ...
    (n = _p(e, t, o, r)),
      n !== null && ((o = Qe()), Pt(n, e, r, o), Zp(n, t, r));
  }
}
function Xp(e) {
  var t = e.alternate;
...
var aa = {
  ...
  O0 = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        Ll(4194308, 4, Hp.bind(null, t, e), n)
      );
    },
    ...
    useReducer: function (e, t, n) {
      ...
      return (
        ...
        (r.queue = e),
        (e = e.dispatch = N0.bind(null, ye, e)),
        [r.memoizedState, e]
      );
    },
    useRef: function (e) {
    ...
    useTransition: function () {
      var e = Ef(!1),
        t = e[0];
      return (e = C0.bind(null, e[1])), ($t().memoizedState = e), [t, e];
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        (o.queue = l),
        wf(Fp.bind(null, r, l, e), [e]),
        (r.flags |= 2048),
        Io(9, zp.bind(null, r, l, n, t), void 0, null),
        n
      );
    },
    useId: function () {
  ...
  _0 = {
    ...
    useDeferredValue: function (e) {
      var t = yt();
      return qp(t, Re.memoizedState, e);
    },
    useTransition: function () {
      var e = ps(Do)[0],
        t = yt().memoizedState;
  ...
  P0 = {
    ...
    useDeferredValue: function (e) {
      var t = yt();
      return Re === null ? (t.memoizedState = e) : qp(t, Re.memoizedState, e);
    },
    useTransition: function () {
      var e = ms(Do)[0],
        t = yt().memoizedState;
  ...
  return (
    ...
    e !== null && !Xe
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~o),
        Zt(e, t, o))
      : (ve && n && hu(t), (t.flags |= 1), Ve(e, t, r, o), t.child)
  );
}
function Rf(e, t, n, r, o) {
  if (e === null) {
    ...
    return typeof l == "function" &&
      ...
      ? ((t.tag = 15), (t.type = l), nm(e, t, l, r, o))
  ...
  if (((l = e.child), (e.lanes & o) === 0)) {
    ...
    if (
      ((n = n.compare), (n = n !== null ? n : Po), n(a, r) && e.ref === t.ref)
    )
      return Zt(e, t, o);
  }
  return (
  ...
  return (
    ...
    e !== null && !Xe
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~o),
        Zt(e, t, o))
      : (ve && r && hu(t), (t.flags |= 1), Ve(e, t, n, o), t.child)
  );
}
function Of(e, t, n, r, o) {
  ...
  if ((kr(t, o), t.stateNode === null))
    jl(e, t), bp(t, n, r), li(t, n, r, o), (r = !0);
  else if (e === null) {
    var a = t.stateNode,
      i = t.memoizedProps;
    a.props = i;
    ...
    (a.state = v),
      ra(t, r, a, o),
      (u = t.memoizedState),
      i !== r || v !== u || Je.current || mn
        ? (typeof f == "function" && (oi(t, n, f, r), (u = t.memoizedState)),
          (i = mn || gf(t, n, i, r, v, u, c))
            ? (d ||
    ...
    i !== d || v !== x || Je.current || mn
      ? (typeof y == "function" && (oi(t, n, y, r), (x = t.memoizedState)),
        (c = mn || gf(t, n, c, r, v, x, u) || !1)
          ? (f ||
...
function ii(e, t, n, r, o, l) {
  om(e, t);
  var a = (t.flags & 128) !== 0;
  if (!r && !a) return o && df(t, n, !1), Zt(e, t, l);
...
function _f(e, t, n, r, o) {
  return _r(), gu(o), (t.flags |= 256), Ve(e, t, n, r), t.child;
}
...
function am(e, t, n) {
  ...
  if (l) {
    ...
    return (
      ...
      i !== null ? (l = _n(i, l)) : ((l = Hn(l, a, n, null)), (l.flags |= 2)),
      (l.return = t),
      (r.return = t),
      (r.sibling = l),
      (t.child = r),
...
function $0(e, t, n, r, o, l, a) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = hs(Error(M(422)))), gl(e, t, a, r))
      : t.memoizedState !== null
  ...
  if (((i = (a & e.childLanes) !== 0), Xe || i)) {
    if (((r = Te), r !== null)) {
      ...
      (o = (o & (r.suspendedLanes | a)) !== 0 ? 0 : o),
        o !== 0 &&
          o !== l.retryLane &&
          ((l.retryLane = o), Jt(e, o), Pt(r, e, o, -1));
    }
    return Iu(), (r = hs(Error(M(421)))), gl(e, t, a, r);
  }
  return o.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function L0(e, t, n) {
  switch (t.tag) {
    ...
    case 10:
      ...
      de(ta, r._currentValue), (r._currentValue = o);
      break;
    case 13:
  ...
  switch ((vu(t), t.tag)) {
        ...
        (e === null || e.child === null) &&
          (hl(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), Ot !== null && (xi(Ot), (Ot = null)))),
        fi(e, t),
        Ie(t),
        null
      );
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = Wn(zt.current)), hl(t))) {
          (r = t.stateNode), (n = t.type);
          var l = t.memoizedProps;
          switch (((r[Mt] = t), (r[$o] = l), (e = (t.mode & 1) !== 0), n)) {
            case "dialog":
            ...
            case "video":
            case "audio":
              for (o = 0; o < ao.length; o++) pe(ao[o], r);
              break;
            case "source":
              pe("error", r);
              break;
          ...
          e: {
            switch (((a = Fs(n, r)), n)) {
              ...
              case "video":
              case "audio":
                for (o = 0; o < ao.length; o++) pe(ao[o], e);
                o = r;
                break;
              case "source":
                pe("error", e), (o = r);
              ...
              if (i.hasOwnProperty(l)) {
                ...
                l === "style"
                  ...
                  : l === "dangerouslySetInnerHTML"
                    ? ((u = u ? u.__html : void 0), u != null && zd(e, u))
                    : l === "children"
                      ? typeof u == "string"
                        ? (n !== "textarea" || u !== "") && ko(e, u)
    ...
    case 6:
      if (e && t.stateNode != null) cm(e, t, e.memoizedProps, r);
        ...
        if (((n = Wn(jo.current)), Wn(zt.current), hl(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Mt] = t),
            (l = r.nodeValue !== n) && ((e = st), e !== null))
          )
            switch (e.tag) {
              case 3:
    ...
    case 13:
      if (
        ...
        if (ve && lt !== null && (t.mode & 1) !== 0 && (t.flags & 128) === 0)
          Op(), _r(), (t.flags |= 98560), (l = !1);
          ...
          if (e === null) {
            ...
            _r(),
              ...
              (t.flags |= 4);
          Ie(t), (l = !1);
        } else Ot !== null && (xi(Ot), (Ot = null)), (l = !0);
    ...
    case 4:
      return (
        Tr(), fi(e, t), e === null && To(t.stateNode.containerInfo), Ie(t), null
      );
    case 10:
    ...
    case 17:
      return Ze(t.type) && Xl(), Ie(t), null;
    case 19:
      if ((he(ge), (l = t.memoizedState), l === null)) return Ie(t), null;
      if (((r = (t.flags & 128) !== 0), (a = l.rendering), a === null))
        if (r) Jr(l, !1);
          ...
          l.tail !== null &&
            Se() > $r &&
            ((t.flags |= 128), (r = !0), Jr(l, !1), (t.lanes = 4194304));
        }
      else {
        if (!r)
          if (((e = oa(a)), e !== null)) {
...
function I0(e, t) {
  ...
  for (Ys = { focusedElem: e, selectionRange: n }, Ql = !1, B = t; B !== null; )
...
function fm(e) {
  ...
  t !== null && ((e.alternate = null), fm(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Mt], delete t[$o], delete t[Zs], delete t[x0], delete t[E0])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function pm(e, t, n) {
  ...
  switch (n.tag) {
    ...
    case 22:
      n.mode & 1
        ? ((Fe = (r = Fe) || n.memoizedState !== null), dn(e, t, n), (Fe = r))
        : dn(e, t, n);
      break;
    default:
      dn(e, t, n);
        ...
        e: for (; i !== null; ) {
          switch (i.tag) {
            case 5:
              ...
              break e;
            case 3:
              (be = i.stateNode.containerInfo), (Rt = !0);
              break e;
            case 4:
              (be = i.stateNode.containerInfo), (Rt = !0);
              break e;
...
function mm(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Ct(t, e), bt(e), r & 512 && n !== null && gr(n, n.return);
      break;
    case 5:
      if (
        (Ct(t, e),
      ...
      if (r & 4 && ((o = e.stateNode), o != null)) {
        ...
        if (((e.updateQueue = null), u !== null))
          try {
            i === "input" && l.type === "radio" && l.name != null && Md(o, l),
              Fs(i, a);
            var c = Fs(i, l);
    ...
    case 3:
      if (
        (Ct(t, e), bt(e), r & 4 && n !== null && n.memoizedState.isDehydrated)
      )
        try {
          Oo(t.containerInfo);
        } catch (w) {
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((Fe = (c = Fe) || f), Ct(t, e), (Fe = c)) : Ct(t, e),
        bt(e),
        r & 8192)
      ) {
        if (
            ...
            (a = B),
              ...
              a.tag === 22 && a.memoizedState !== null
                ...
                : u !== null
                  ? ((u.return = a), (B = u))
                  : Mf(o);
        for (; l !== null; ) (B = l), hm(l), (l = l.sibling);
        (B = o), (yl = i), (Fe = c);
      }
      Lf(e);
    } else
...
var F0 = Math.ceil,
  sa = rn.ReactCurrentDispatcher,
  $u = rn.ReactCurrentOwner,
  vt = rn.ReactCurrentBatchConfig,
  se = 0,
  Te = null,
  ke = null,
  $e = 0,
  ...
  Dl = 0;
function Qe() {
  return (se & 6) !== 0 ? Se() : Ml !== -1 ? Ml : (Ml = Se());
}
function On(e) {
  return (e.mode & 1) === 0
    ? 1
...
function Pt(e, t, n, r) {
  if (50 < go) throw ((go = 0), (gi = null), Error(M(185)));
  Ho(e, n, r),
    ((se & 2) === 0 || e !== Te) &&
      (e === Te && ((se & 2) === 0 && ($a |= n), Oe === 4 && gn(e, $e)),
      et(e, r),
      n === 1 &&
        se === 0 &&
        (t.mode & 1) === 0 &&
...
function et(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && Uc(n), t === 1))
      e.tag === 0 ? w0(Df.bind(null, e)) : Cp(Df.bind(null, e)),
        g0(function () {
          (se & 6) === 0 && jn();
        }),
        (n = null);
      ...
      n = km(n, vm.bind(null, e));
    }
    (e.callbackPriority = t), (e.callbackNode = n);
  }
}
function vm(e, t) {
  if (((Ml = -1), (Dl = 0), (se & 6) !== 0)) throw Error(M(327));
  var n = e.callbackNode;
  ...
  if ((r & 30) !== 0 || (r & e.expiredLanes) !== 0 || t) t = ca(e, r);
    ...
    se |= 2;
    var l = ym();
    (Te !== e || $e !== t) && ((Wt = null), ($r = Se() + 500), Vn(e, t));
    do
      try {
        W0();
        break;
    ...
    xu(),
      (sa.current = l),
      (se = o),
      ke !== null ? (t = 0) : ((Te = null), ($e = 0), (t = Oe));
  }
  if (t !== 0) {
    if (
      (t === 2 && ((o = Vs(e)), o !== 0 && ((r = o), (t = yi(e, o)))), t === 1)
    )
      throw ((n = zo), Vn(e, 0), gn(e, r), et(e, Se()), n);
    if (t === 6) gn(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = o), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            (gn(e, r), (r & 130023424) === r && ((t = ju + 500 - Se()), 10 < t))
          ) {
            if (Kl(e, 0) !== 0) break;
            ...
            e.timeoutHandle = Js(Fn.bind(null, e, Ye, Wt), t);
            break;
          }
          Fn(e, Ye, Wt);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = Js(Fn.bind(null, e, Ye, Wt), r);
            break;
          }
          Fn(e, Ye, Wt);
          break;
  ...
  return et(e, Se()), e.callbackNode === n ? vm.bind(null, e) : null;
}
function yi(e, t) {
  var n = vo;
  return (
...
function Df(e) {
  ...
  Cr();
  var t = Kl(e, 0);
  if ((t & 1) === 0) return et(e, Se()), null;
  var n = ca(e, t);
  if (e.tag !== 0 && n === 2) {
    var r = Vs(e);
    r !== 0 && ((t = r), (n = yi(e, r)));
  }
  if (n === 1) throw ((n = zo), Vn(e, 0), gn(e, t), et(e, Se()), n);
...
function Mu(e, t) {
  ...
  try {
    ...
    (se = n), se === 0 && (($r = Se() + 500), _a && jn());
  }
}
function Xn(e) {
  En !== null && En.tag === 0 && (se & 6) === 0 && Cr();
  var t = se;
  se |= 1;
  var n = vt.transition,
    r = ue;
  try {
    ...
    (ue = r), (vt.transition = n), (se = t), (se & 6) === 0 && jn();
  }
}
function Du() {
  (rt = yr.current), he(yr);
...
function Vn(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), v0(n)), ke !== null))
...
function ca(e, t) {
  ...
  while (1);
  if ((xu(), (se = n), (sa.current = r), ke !== null)) throw Error(M(261));
  return (Te = null), ($e = 0), Oe;
}
function B0() {
  for (; ke !== null; ) xm(ke);
}
function W0() {
  for (; ke !== null && !pg(); ) xm(ke);
}
function xm(e) {
  var t = Sm(e.alternate, e, rt);
...
function Fn(e, t, n) {
  var r = ue,
    o = vt.transition;
  try {
    (vt.transition = null), (ue = 1), U0(e, t, n, r);
  } finally {
...
function U0(e, t, n, r) {
  ...
  if (ia) throw ((ia = !1), (e = vi), (vi = null), e);
  return (
    (ua & 1) !== 0 && e.tag !== 0 && Cr(),
    (l = e.pendingLanes),
    (l & 1) !== 0 ? (e === gi ? go++ : ((go = 0), (gi = e))) : (go = 0),
    jn(),
    null
  );
}
function Cr() {
  if (En !== null) {
    var e = Zd(ua),
      ...
      n = ue;
    try {
      if (((vt.transition = null), (ue = 16 > e ? 16 : e), En === null))
        var r = !1;
      else {
        if (((e = En), (En = null), (ua = 0), (se & 6) !== 0))
          throw Error(M(331));
        var o = se;
        ...
        if (
          ((se = o), jn(), It && typeof It.onPostCommitFiberRoot == "function")
        )
          try {
...
function V0(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    Te === e &&
      ($e & n) === n &&
      (Oe === 4 || (Oe === 3 && ($e & 130023424) === $e && 500 > Se() - ju)
        ? Vn(e, 0)
        : (Lu |= n)),
    et(e, t);
}
function wm(e, t) {
  ...
  var n = Qe();
  (e = Jt(e, t)), e !== null && (Ho(e, t, n), et(e, n));
}
function H0(e) {
  var t = e.memoizedState,
    n = 0;
...
Sm = function (e, t, n) {
  ...
  else (Xe = !1), ve && (t.flags & 1048576) !== 0 && Np(t, ea, t.index);
  switch (((t.lanes = 0), t.tag)) {
    case 2:
      var r = t.type;
      jl(e, t), (e = t.pendingProps);
      var o = Or(t, Ae.current);
      kr(t, n), (o = Ou(null, t, r, e, o, n));
      var l = _u();
      return (
        (t.flags |= 1),
        typeof o == "object" &&
        ...
        o.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            li(t, r, e, n),
            (t = ii(null, t, r, !0, l, n)))
          : ((t.tag = 0), ve && l && hu(t), Ve(null, t, o, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
    ...
    case 3:
      e: {
        if ((lm(t), e === null)) throw Error(M(387));
        (r = t.pendingProps),
          (l = t.memoizedState),
          (o = l.element),
          Pp(e, t),
        ...
        if (((r = a.element), l.isDehydrated))
          if (
            ...
            (o = br(Error(M(423)), t)), (t = _f(e, t, r, n, o));
            break e;
          } else if (r !== o) {
            (o = br(Error(M(424)), t)), (t = _f(e, t, r, n, o));
            break e;
          } else
            for (
    ...
    case 5:
      return (
        ...
        (a = o.children),
        Xs(r, o) ? (a = null) : l !== null && Xs(r, l) && (t.flags |= 32),
        om(e, t),
        Ve(e, t, a, n),
        t.child
      );
    ...
    case 4:
      return (
        ku(t, t.stateNode.containerInfo),
        (r = t.pendingProps),
        e === null ? (t.child = Pr(t, null, r, n)) : Ve(e, t, r, n),
        t.child
      );
    case 11:
      return (
...
function Il(e, t, n, r, o, l) {
  ...
  if (((r = e), typeof e == "function")) zu(e) && (a = 1);
    ...
    e: switch (e) {
      case ir:
        return Hn(n.children, o, l, t);
      case nu:
        (a = 8), (o |= 8);
        break;
      case Ps:
        return (
          (e = mt(12, n, t, o | 2)), (e.elementType = Ps), (e.lanes = l), e
        );
      case Ts:
        return (e = mt(13, n, t, o)), (e.elementType = Ts), (e.lanes = l), e;
      case bs:
        return (e = mt(19, n, t, o)), (e.elementType = bs), (e.lanes = l), e;
      case $d:
        return La(n, o, l, t);
      default:
        if (typeof e == "object" && e !== null)
  ...
  return (
    (t = mt(a, n, t, o)), (t.elementType = e), (t.type = r), (t.lanes = l), t
  );
}
function Hn(e, t, n, r) {
...
function Cm(e) {
  ...
  if (e.tag === 1) {
    var n = e.type;
    if (Ze(n)) return kp(e, n, t);
  }
  return t;
}
function Nm(e, t, n, r, o, l, a, i, u) {
  return (
    (e = Fu(n, r, !0, e, o, l, a, i, u)),
    (e.context = Cm(null)),
    (n = e.current),
    (r = Qe()),
    (o = On(n)),
...
Ma.prototype.render = Bu.prototype.render = function (e) {
...
function J0(e, t, n, r, o) {
  ...
  var u = Fu(e, 0, !1, null, null, !1, !1, "", Ff);
  return (
...
Ud = Mu;
Vd = Xn;
var Z0 = { usingClientEntryPoint: !1, Events: [Qo, dr, Oa, Bd, Wd, Mu] },
  Zr = {
  ...
  ey = {
    ...
    findFiberByHostInstance: Zr.findFiberByHostInstance || X0,
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!El.isDisabled && El.supportsFiber)
    try {
      (ka = El.inject(ey)), (It = El);
    } catch {}
}
ut.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Z0;
ut.createPortal = function (e, t) {
  var n = 2 < arguments.length && arguments[2] !== void 0 ? arguments[2] : null;
  if (!Wu(t)) throw Error(M(200));
  return Y0(e, t, null, n);
};
ut.createRoot = function (e, t) {
  if (!Wu(e)) throw Error(M(299));
  var n = !1,
    r = "",
    o = Rm;
  return (
...
ut.hydrateRoot = function (e, t, n) {
  ...
  if (
    ...
    (t = Nm(t, null, e, 1, n != null ? n : null, o, !1, l, a)),
    (e[Xt] = t.current),
    To(e),
    r)
  )
...
const Un = yd(Ji.exports);
var Om,
  Af = Ji.exports;
(Om = Af.createRoot), Af.hydrateRoot;
...
function ay(e, t, n, r = {}) {
  ...
  function d() {
    ...
    let k = f(),
      m = k == null ? null : k - c;
    (c = k), u && u({ action: i, location: w.location, delta: m });
  }
  function v(k, m) {
    i = "PUSH";
    let h = Ei(w.location, k, m);
    n && n(h, k), (c = f() + 1);
    let g = Uf(h, c),
      E = w.createHref(h);
    try {
  ...
  let w = {
    ...
    listen(k) {
      ...
      return (
        ...
        (u = k),
        () => {
          o.removeEventListener(Wf, d), (u = null);
        }
      );
    },
    createHref(k) {
...
function Pm(e, t = [], n = [], r = "", o = !1) {
  let l = (a, i, u = o, c) => {
    ...
    a.children &&
      ...
      Pm(a.children, t, v, d, u)),
      !(a.path == null && !a.index) &&
        t.push({ path: d, score: vy(d, a.index), routesMeta: v });
  };
  return (
    e.forEach((a, i) => {
      var u;
      if (a.path === "" || !((u = a.path) != null && u.includes("?"))) l(a, i);
      else for (let c of Tm(a.path)) l(a, i, !0, c);
    }),
    t
  );
}
...
function vy(e, t) {
  ...
  return (
    ...
    n
      .filter((o) => !Vf(o))
      .reduce((o, l) => o + (cy.test(l) ? fy : l === "" ? py : my), r)
  );
}
function gy(e, t) {
  ...
  for (let i = 0; i < r.length; ++i) {
    ...
    Object.assign(o, d.params),
      a.push({
        ...
        pathnameBase: Cy(Gt([l, d.pathnameBase])),
        route: v,
      }),
...
function da(e, t) {
  ...
  let l = o[0],
    ...
    i = o.slice(1);
  return {
    params: r.reduce((c, { paramName: f, isOptional: d }, v) => {
      if (f === "*") {
        let x = i[v] || "";
...
function Sy(e, t = "/") {
  ...
  if (n)
    if (wy(n)) l = n;
      ...
      n.startsWith("/") ? (l = Hf(n.substring(1), "/")) : (l = Hf(n, t));
    }
  else l = t;
  return { pathname: l, search: Ny(r), hash: Ry(o) };
}
function Hf(e, t) {
...
function Lm(e, t, n, r = !1) {
  ...
  typeof e == "string"
    ...
    : ((o = { ...e }),
      ...
      Ce(!o.search || !o.search.includes("#"), xs("#", "search", "hash", o)));
  let l = e === "" || o.pathname === "",
    a = l ? "/" : o.pathname,
    i;
  if (a == null) i = n;
...
[...Ty];
var Br = p.exports.createContext(null);
Br.displayName = "DataRouter";
var za = p.exports.createContext(null);
za.displayName = "DataRouterState";
var by = p.exports.createContext(!1),
  Dm = p.exports.createContext({ isTransitioning: !1 });
Dm.displayName = "ViewTransition";
var $y = p.exports.createContext(new Map());
$y.displayName = "Fetchers";
var Ly = p.exports.createContext(null);
Ly.displayName = "Await";
var St = p.exports.createContext(null);
St.displayName = "Navigation";
var qo = p.exports.createContext(null);
qo.displayName = "Location";
var on = p.exports.createContext({
  outlet: null,
  matches: [],
  isDataRoute: !1,
});
on.displayName = "Route";
var Uu = p.exports.createContext(null);
Uu.displayName = "RouteError";
var Im = "REACT_ROUTER_ERROR",
  jy = "REDIRECT",
  My = "ROUTE_ERROR_RESPONSE";
function Dy(e) {
  if (e.startsWith(`${Im}:${jy}:{`))
    try {
  ...
  if (e.startsWith(`${Im}:${My}:{`))
    try {
      ...
      if (
        ...
        return new Oy(t.status, t.statusText, t.data);
    } catch {}
}
function zy(e, { relative: t } = {}) {
  Ce(
    Yo(),
    "useHref() may be used only in the context of a <Router> component.",
  );
  let { basename: n, navigator: r } = p.exports.useContext(St),
...
function Yo() {
  return p.exports.useContext(qo) != null;
}
function ln() {
  return (
    Ce(
    ...
    p.exports.useContext(qo).location
  );
}
var zm =
  "You should call navigate() in a React.useEffect(), not when your component is first rendered.";
function Fm(e) {
  p.exports.useContext(St).static || p.exports.useLayoutEffect(e);
}
function Xo() {
  let { isDataRoute: e } = p.exports.useContext(on);
  return e ? Xy() : Fy();
}
function Fy() {
  Ce(
  ...
  let e = p.exports.useContext(Br),
    { basename: t, navigator: n } = p.exports.useContext(St),
    { matches: r } = p.exports.useContext(on),
    { pathname: o } = ln(),
  ...
  return (
    ...
    p.exports.useCallback(
      (u, c = {}) => {
        if ((xt(a.current, zm), !a.current)) return;
        if (typeof u == "number") {
          n.go(u);
          return;
        }
        let f = Lm(u, JSON.parse(l), o, c.relative === "path");
        e == null &&
          t !== "/" &&
...
function Jo(e, { relative: t } = {}) {
  let { matches: n } = p.exports.useContext(on),
    { pathname: r } = ln(),
    o = JSON.stringify($m(n));
  return p.exports.useMemo(
    () => Lm(e, JSON.parse(o), r, t === "path"),
    [e, o, r, t],
  );
}
function Ay(e, t, n, r, o) {
  ...
  let { navigator: l } = p.exports.useContext(St),
    { matches: a } = p.exports.useContext(on),
    i = a[a.length - 1],
    u = i ? i.params : {},
    c = i ? i.pathname : "/",
    f = i ? i.pathnameBase : "/",
...
Please change the parent <Route path="${g}"> to <Route path="${
  ...
  let v = ln(),
    y;
  if (t) {
    let g = typeof t == "string" ? Ar(t) : t;
    Ce(
      f === "/" || ((h = g.pathname) == null ? void 0 : h.startsWith(f)),
  ...
  if (f !== "/") {
    ...
    w = "/" + x.replace(/^\//, "").split("/").slice(g.length).join("/");
  }
  let k = _m(e, { pathname: w });
  xt(
    d || k != null,
...
var Wy = p.exports.createElement(By, null),
  Am = class extends p.exports.Component {
    constructor(e) {
      super(e),
        (this.state = {
          location: e.location,
      ...
      let t =
        e !== void 0
          ? p.exports.createElement(
              ...
              p.exports.createElement(Uu.Provider, {
                value: e,
                children: this.props.component,
              }),
            )
          : this.props.children;
      return this.context ? p.exports.createElement(Uy, { error: e }, t) : t;
    }
  };
Am.contextType = by;
var Es = new WeakMap();
function Uy({ children: e, error: t }) {
  let { basename: n } = p.exports.useContext(St);
  if (
    typeof t == "object" &&
    t &&
    "digest" in t &&
...
function Vy({ routeContext: e, match: t, children: n }) {
  let r = p.exports.useContext(Br);
  return (
    r &&
      r.static &&
      r.staticContext &&
    ...
    p.exports.createElement(on.Provider, { value: e }, n)
  );
}
function Hy(e, t = [], n = null, r = null, o = null) {
  if (e == null) {
    if (!n) return null;
    ...
    n && r
      ? (f, d) => {
          ...
          r(f, {
            ...
            params:
              (x =
                (y = (v = n.matches) == null ? void 0 : v[0]) == null
                  ? void 0
                  : y.params) != null
                ? x
                : {},
            unstable_pattern: Py(n.matches),
            errorInfo: d,
          });
        }
      : void 0;
      ...
      i &&
        (u < 0 && v === 0
          ? (Bm(
            ...
            (k = null))
          : u === v &&
            ((x = !0), (k = d.route.hydrateFallbackElement || null))));
        ...
        return (
          y
            ...
            : x
              ? (g = k)
              : d.route.Component
                ? (g = p.exports.createElement(d.route.Component, null))
                : d.route.element
                  ? (g = d.route.element)
                  : (g = f),
          p.exports.createElement(Vy, {
            match: d,
...
function Yy() {
  var r;
  let e = p.exports.useContext(Uu),
    t = Qy("useRouteError"),
    n = Hu("useRouteError");
  return e !== void 0 ? e : (r = t.errors) == null ? void 0 : r[n];
}
function Xy() {
  let { router: e } = Ky("useNavigate"),
    t = Hu("useNavigate"),
...
var Kf = {};
function Bm(e, t, n) {
  !t && !Kf[e] && ((Kf[e] = !0), xt(!1, n));
}
var Jy = "useOptimistic";
Jv[Jy];
p.exports.memo(Zy);
function Zy({ routes: e, future: t, state: n, onError: r }) {
  return Ay(e, void 0, n, r, t);
}
function e1({
  basename: e = "/",
  children: t = null,
  ...
  return (
    ...
    x == null
      ...
      : p.exports.createElement(
          St.Provider,
          { value: u },
          p.exports.createElement(qo.Provider, { children: t, value: x }),
        )
  );
}
var zl = "get",
  Fl = "application/x-www-form-urlencoded";
function Fa(e) {
...
function ws(e) {
  return e != null && !i1.has(e)
    ? (xt(
        !1,
        `"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Fl}"`,
      ),
      null)
    : e;
}
function u1(e, t) {
  ...
  if (n1(e)) {
    ...
    (r = i ? en(i, t) : null),
      ...
      (o = ws(e.getAttribute("enctype")) || Fl),
      (l = new FormData(e));
...
async function f1(e, t) {
  ...
  try {
    let n = await ry(() => import(e.module), []);
    return (t[e.id] = n), n;
  } catch (n) {
    return (
      console.error(
...
function y1(e, t) {
  let n = new Set(),
    r = new Set(t);
  return e.reduce((o, l) => {
    if (t && !d1(l) && l.as === "script" && l.href && r.has(l.href)) return o;
    let i = JSON.stringify(g1(l));
...
var Qu = p.exports.createContext(void 0);
Qu.displayName = "FrameworkContext";
function Um() {
  let e = p.exports.useContext(Qu);
  return (
    Ku(e, "You must render this element inside a <HydratedRouter> element"), e
  );
}
function E1(e, t) {
  let n = p.exports.useContext(Qu),
...
function w1({ page: e, ...t }) {
  let { router: n } = Wm(),
    r = p.exports.useMemo(
      () => _m(n.routes, e, n.basename),
      [n.routes, e, n.basename],
    );
  return r ? p.exports.createElement(k1, { page: e, matches: r, ...t }) : null;
}
function S1(e) {
  let { manifest: t, routeModules: n } = Um(),
...
function k1({ page: e, matches: t, ...n }) {
  let r = ln(),
    { future: o, manifest: l, routeModules: a } = Um(),
    { basename: i } = Wm(),
    { loaderData: u, matches: c } = x1(),
    f = p.exports.useMemo(() => Qf(e, t, c, l, r, "data"), [e, t, c, l, r]),
    d = p.exports.useMemo(() => Qf(e, t, c, l, r, "assets"), [e, t, c, l, r]),
    v = p.exports.useMemo(() => {
      ...
      if (
        (t.forEach((h) => {
          var E;
          let g = l.routes[h.route.id];
          !g ||
            !g.hasLoader ||
            ((!f.some((S) => S.route.id === h.route.id) &&
              h.route.id in u &&
              ((E = a[h.route.id]) == null ? void 0 : E.shouldRevalidate)) ||
            g.hasClientLoader
              ? (k = !0)
              : w.add(h.route.id));
        }),
        ...
        return [];
      let m = c1(e, i, o.unstable_trailingSlashAwareDataRequests, "data");
      return (
        k &&
          w.size > 0 &&
          m.searchParams.set(
    ...
    y = p.exports.useMemo(() => h1(d, l), [d, l]),
    x = S1(d);
  return p.exports.createElement(
    ...
    x.map(({ key: w, link: k }) =>
      p.exports.createElement("link", { key: w, nonce: n.nonce, ...k }),
    ),
  );
}
function C1(...e) {
...
var N1 =
  ...
  typeof window.document.createElement < "u";
try {
  N1 && (window.__reactRouterVersion = "7.12.0");
} catch {}
function R1({
  basename: e,
  children: t,
  ...
  o.current == null && (o.current = oy({ window: r, v5Compat: !0 }));
  let l = o.current,
...
var Vm = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Hm = p.exports.forwardRef(function (
    {
      onClick: t,
      discover: n = "render",
      prefetch: r = "none",
    ...
    let { basename: w, unstable_useTransitions: k } = p.exports.useContext(St),
      m = typeof c == "string" && Vm.test(c),
      h = Mm(c, w);
    c = h.to;
    let g = zy(c, { relative: o }),
      [E, S, N] = E1(r, y),
      C = T1(c, {
        replace: a,
        state: i,
    ...
    function R(j) {
      t && t(j), j.defaultPrevented || C(j);
    }
    let $ = p.exports.createElement("a", {
      ...y,
      ...N,
      href: h.absoluteURL || g,
      onClick: h.isExternal || l ? t : R,
      ref: C1(x, S),
      target: u,
    ...
    return E && !m
      ? p.exports.createElement(
          ...
          null,
          $,
          p.exports.createElement(w1, { page: g }),
        )
      : $;
  });
Hm.displayName = "Link";
var O1 = p.exports.forwardRef(function (
  {
    "aria-current": t = "page",
    caseSensitive: n = !1,
    className: r = "",
  ...
  let d = Jo(a, { relative: c.relative }),
    v = ln(),
    y = p.exports.useContext(za),
    { navigator: x, basename: w } = p.exports.useContext(St),
    k = y != null && M1(d) && i === !0,
    m = x.encodeLocation ? x.encodeLocation(d).pathname : d.pathname,
    h = v.pathname,
    g =
  ...
  let S = h === m || (!o && h.startsWith(m) && h.charAt(E) === "/"),
    N =
      g != null &&
      (g === m || (!o && g.startsWith(m) && g.charAt(m.length) === "/")),
    C = { isActive: S, isPending: N, isTransitioning: k },
    R = S ? t : void 0,
    $;
  typeof r == "function"
    ? ($ = r(C))
...
var _1 = p.exports.forwardRef(
  (
    ...
    let { unstable_useTransitions: w } = p.exports.useContext(St),
      k = L1(),
      m = j1(i, { relative: c }),
      h = a.toLowerCase() === "get" ? "get" : "post",
      g = typeof i == "string" && Vm.test(i),
      E = (S) => {
        if ((u && u(S), S.defaultPrevented)) return;
        S.preventDefault();
        let N = S.nativeEvent.submitter,
          C = (N == null ? void 0 : N.getAttribute("formmethod")) || a,
          R = () =>
            k(N || S.currentTarget, {
              fetcherKey: t,
              method: C,
        ...
        w && n !== !1 ? p.exports.startTransition(() => R()) : R();
      };
  ...
  return p.exports.useCallback(
    (v) => {
      if (l1(v, t)) {
        ...
        u ? p.exports.startTransition(() => x()) : x();
      }
    },
...
function Gu(e) {
  ...
  let t = p.exports.useRef(wi(e)),
    n = p.exports.useRef(!1),
    r = ln(),
    o = p.exports.useMemo(
      () => a1(r.search, n.current ? null : t.current),
      [r.search],
    ),
    l = Xo(),
    a = p.exports.useCallback(
      (i, u) => {
        const c = wi(typeof i == "function" ? i(new URLSearchParams(o)) : i);
        (n.current = !0), l("?" + c, u);
      },
      [l, o],
    );
...
function L1() {
  let { router: e } = Km("useSubmit"),
    { basename: t } = p.exports.useContext(St),
    n = qy(),
    r = e.fetch,
    o = e.navigate;
  return p.exports.useCallback(
    async (l, a = {}) => {
      let { action: i, method: u, encType: c, formData: f, body: d } = u1(l, t);
      if (a.navigate === !1) {
        let v = a.fetcherKey || $1();
        await r(v, n, a.action || i, {
...
function j1(e, { relative: t } = {}) {
  let { basename: n } = p.exports.useContext(St),
    r = p.exports.useContext(on);
...
function M1(e, { relative: t } = {}) {
  let n = p.exports.useContext(Dm);
  Ce(
    n != null,
    "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?",
  );
  let { basename: r } = Km("useViewTransitionState"),
    o = Jo(e, { relative: t });
  if (!n.isTransitioning) return !1;
  let l = en(n.currentLocation.pathname, r) || n.currentLocation.pathname,
    a = en(n.nextLocation.pathname, r) || n.nextLocation.pathname;
 ...
 */ var D1 = p.exports,
  ...
  A1 = D1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function Gm(e, t, n) {
  ...
  for (r in t) F1.call(t, r) && !B1.hasOwnProperty(r) && (o[r] = t[r]);
  if (e && e.defaultProps)
...
const W1 = ["xxl", "xl", "lg", "md", "sm", "xs"],
  U1 = "xs",
  Ba = p.exports.createContext({
    prefixes: {},
    breakpoints: W1,
    minBreakpoint: U1,
  });
function Z(e, t) {
  const { prefixes: n } = p.exports.useContext(Ba);
  return e || n[t] || t;
}
function qm() {
  const { breakpoints: e } = p.exports.useContext(Ba);
  return e;
}
function Ym() {
  const { minBreakpoint: e } = p.exports.useContext(Ba);
  return e;
}
function qu() {
  const { dir: e } = p.exports.useContext(Ba);
  return e === "rtl";
}
const V1 = { fluid: !1 },
  Yu = p.exports.forwardRef(
    ({ bsPrefix: e, fluid: t, as: n = "div", className: r, ...o }, l) => {
      const a = Z(e, "container"),
        i = typeof t == "string" ? `-${t}` : "-fluid";
      return b.exports.jsx(n, {
        ref: l,
        ...o,
        className: q(r, t ? `${a}${i}` : a),
      });
    },
  );
Yu.displayName = "Container";
Yu.defaultProps = V1;
const Lt = p.exports.forwardRef(
  ({ bsPrefix: e, className: t, as: n = "div", ...r }, o) => {
    ...
    return (
      ...
      b.exports.jsx(n, { ref: o, ...r, className: q(t, l, ...c) })
    );
  },
);
Lt.displayName = "Row";
function H1({ as: e, bsPrefix: t, className: n, ...r }) {
  t = Z(t, "col");
  const o = qm(),
    l = Ym(),
    a = [],
...
const He = p.exports.forwardRef((e, t) => {
  const [{ className: n, ...r }, { as: o = "div", bsPrefix: l, spans: a }] =
    H1(e);
  return b.exports.jsx(o, { ...r, ref: t, className: q(n, !a.length && l) });
});
He.displayName = "Col";
function Wr(e) {
...
function Q1(e, t) {
  return K1(e).getComputedStyle(e, t);
}
var G1 = /([A-Z])/g;
function q1(e) {
  return e.replace(G1, "-$1").toLowerCase();
}
var Y1 = /^ms-/;
function Sl(e) {
  return q1(e).replace(Y1, "-ms-");
}
var X1 =
...
var O = { exports: {} },
  ex = "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",
  tx = ex,
  nx = tx;
function Jm() {}
function Zm() {}
Zm.resetWarningCache = Jm;
var rx = function () {
...
var ox = function (t) {
  ...
  an = (function (e) {
    ...
    t.getDerivedStateFromProps = function (o, l) {
      var a = o.in;
      return a && l.status === so ? { status: hn } : null;
    };
    var n = t.prototype;
    return (
      ...
      (n.updateStatus = function (o, l) {
        if ((o === void 0 && (o = !1), l !== null))
          if ((this.cancelNextCallback(), l === jt)) {
...
try {
  ...
  Ur &&
    ...
    window.removeEventListener("test", Ss, !0));
} catch {}
function th(e, t, n, r) {
  if (r && typeof r != "boolean" && !Ci) {
    var o = r.once,
      l = r.capture,
      a = n;
    !Ci &&
...
function rh(e, t) {
  const n = qf(e, "transitionDuration"),
    r = qf(e, "transitionDelay"),
    o = nh(
      e,
      (l) => {
        l.target === e && (o(), t(l));
...
const lh = s.forwardRef(
    (
      ...
      const d = p.exports.useRef(null),
        ...
        w = p.exports.useCallback(x(e), [e]),
        k = p.exports.useCallback(x(t), [t]),
        m = p.exports.useCallback(x(n), [n]),
        h = p.exports.useCallback(x(r), [r]),
        g = p.exports.useCallback(x(o), [o]),
        E = p.exports.useCallback(x(l), [l]),
        S = p.exports.useCallback(x(a), [a]);
      return b.exports.jsx(an, {
        ref: f,
        ...c,
        onEnter: w,
        onEntered: m,
    ...
    (
      ...
      const d = typeof i == "function" ? i() : i,
        ...
        y = p.exports.useMemo(
          () =>
            to((m) => {
              const h = `scroll${d[0].toUpperCase()}${d.slice(1)}`;
              m.style[d] = `${m[h]}px`;
            }, t),
          [d, t],
        ),
...
Xu.defaultProps = fx;
var dx = ["color", "size", "title", "className"];
function Ri() {
  return (
    (Ri = Object.assign
      ? Object.assign.bind()
...
sh.propTypes = {
  ...
  size: O.exports.oneOfType([O.exports.string, O.exports.number]),
  title: O.exports.string,
  className: O.exports.string,
};
const ih = sh;
var hx = ["color", "size", "title", "className"];
function Oi() {
  return (
    (Oi = Object.assign
      ? Object.assign.bind()
...
var uh = p.exports.forwardRef(function (e, t) {
  var n = e.color,
    r = n === void 0 ? "currentColor" : n,
    o = e.size,
    l = o === void 0 ? "1em" : o,
...
const Ju = ch;
var Sx = ["color", "size", "title", "className"];
function Pi() {
  return (
    (Pi = Object.assign
      ? Object.assign.bind()
...
const Nx = fh;
var Rx = ["color", "size", "title", "className"];
function Ti() {
  return (
    (Ti = Object.assign
      ? Object.assign.bind()
...
var dh = p.exports.forwardRef(function (e, t) {
  var n = e.color,
    r = n === void 0 ? "currentColor" : n,
    o = e.size,
    l = o === void 0 ? "1em" : o,
...
const Lx = ph;
var jx = ["color", "size", "title", "className"];
function $i() {
  return (
    ($i = Object.assign
      ? Object.assign.bind()
...
var xh = p.exports.forwardRef(function (e, t) {
  var n = e.color,
    r = n === void 0 ? "currentColor" : n,
    o = e.size,
    l = o === void 0 ? "1em" : o,
...
const tE = wh;
var nE = ["color", "size", "title", "className"];
function zi() {
  return (
    (zi = Object.assign
      ? Object.assign.bind()
...
function rr({
  ...
  return s.createElement(
    ...
    s.createElement(Xu, { in: c }, s.createElement("div", null, t)),
  );
}
function Fi() {
  return (
...
function Nh(e, t) {
  return Object.keys(t).reduce(function (n, r) {
    var o,
      ...
      a = l[Xf(r)],
      i = l[r],
      u = Xm(l, [Xf(r), r].map(aE)),
      c = t[r],
      f = Ch(i, a, e[c]),
      d = f[0],
      v = f[1];
    return Fi({}, u, ((o = {}), (o[r] = d), (o[c] = v), o));
  }, e);
}
function Rh(e, t) {
  ...
  (
    ...
    return (
      ...
      b.exports.jsx(Xu, {
        ...
        ...l,
        className: q(n, t),
        children: b.exports.jsx(e, { children: p.exports.Children.only(r) }),
      })
    );
  },
);
Zu.displayName = "AccordionCollapse";
const Wa = p.exports.createContext({ eventKey: "" });
Wa.displayName = "AccordionItemContext";
const Oh = p.exports.forwardRef(
  (
    {
      as: e = "div",
      bsPrefix: t,
    ...
    const { eventKey: d } = p.exports.useContext(Wa);
    return b.exports.jsx(Zu, {
      eventKey: d,
      onEnter: r,
      onEntering: o,
      onEntered: l,
      ...
      onExiting: i,
      onExited: u,
      children: b.exports.jsx(e, { ref: f, ...c, className: q(n, t) }),
    });
  },
);
Oh.displayName = "AccordionBody";
function iE(e, t) {
  const {
    activeEventKey: n,
    onSelect: r,
  ...
  ({ as: e = "button", bsPrefix: t, className: n, onClick: r, ...o }, l) => {
    ...
    return (
      ...
      b.exports.jsx(e, {
        ...
        ...o,
        "aria-expanded": a === u,
        className: q(n, t, !Rh(u, a) && "collapsed"),
      })
    );
  },
);
ec.displayName = "AccordionButton";
const _h = p.exports.forwardRef(
  (
    { as: e = "h2", bsPrefix: t, className: n, children: r, onClick: o, ...l },
    a,
  ) => (
    (t = Z(t, "accordion-header")),
    b.exports.jsx(e, {
      ref: a,
      ...l,
      className: q(n, t),
      children: b.exports.jsx(ec, { onClick: o, children: r }),
    })
  ),
);
_h.displayName = "AccordionHeader";
const Ph = p.exports.forwardRef(
  ({ as: e = "div", bsPrefix: t, className: n, eventKey: r, ...o }, l) => {
    t = Z(t, "accordion-item");
    const a = p.exports.useMemo(() => ({ eventKey: r }), [r]);
    return b.exports.jsx(Wa.Provider, {
      value: a,
      children: b.exports.jsx(e, { ref: l, ...o, className: q(n, t) }),
    });
  },
);
Ph.displayName = "AccordionItem";
const Th = p.exports.forwardRef((e, t) => {
  const {
      as: n = "div",
      activeKey: r,
      bsPrefix: o,
      ...
      alwaysOpen: u,
      ...c
    } = Nh(e, { activeKey: "onSelect" }),
    f = Z(o, "accordion"),
    d = p.exports.useMemo(
      () => ({ activeEventKey: r, onSelect: a, alwaysOpen: u }),
      [r, a, u],
    );
  return b.exports.jsx(el.Provider, {
    value: d,
    children: b.exports.jsx(n, {
      ref: t,
      ...c,
      className: q(l, f, i && `${f}-flush`),
    }),
  });
});
Th.displayName = "Accordion";
const ft = Object.assign(Th, {
    Button: ec,
    Collapse: Zu,
    Item: Ph,
    Header: _h,
  ...
  uE = { vertical: !1, role: "group" },
  tc = p.exports.forwardRef(
    (
      { bsPrefix: e, size: t, vertical: n, className: r, as: o = "div", ...l },
      a,
    ) => {
      const i = Z(e, "btn-group");
      let u = i;
      return (
        n && (u = `${i}-vertical`),
        b.exports.jsx(o, { ...l, ref: a, className: q(r, u, t && `${i}-${t}`) })
      );
    },
  );
tc.displayName = "ButtonGroup";
tc.defaultProps = uE;
const ma = p.exports.forwardRef(
    (
      ...
      const d = Z(e, "table"),
        ...
        y = b.exports.jsx("table", { ...c, className: v, ref: f });
      if (u) {
        let x = `${d}-responsive`;
        return (
          typeof u == "string" && (x = `${x}-${u}`),
          b.exports.jsx("div", { className: x, children: y })
        );
      }
      return y;
    },
...
function nc({
  ...
  const f = (v) => {
      if (((t || (e === "a" && dE(n))) && v.preventDefault(), t)) {
        v.stopPropagation();
        return;
      }
      a == null || a(v);
...
const pE = p.exports.forwardRef((e, t) => {
  let { as: n, disabled: r } = e,
    o = fE(e, cE);
  const [l, { tagName: a }] = nc(Object.assign({ tagName: n, disabled: r }, o));
  return b.exports.jsx(a, Object.assign({}, o, l, { ref: t }));
});
pE.displayName = "Button";
const mE = { variant: "primary", active: !1, disabled: !1 },
  at = p.exports.forwardRef(
    (
      {
        as: e,
        bsPrefix: t,
      ...
      const u = Z(t, "btn"),
        [c, { tagName: f }] = nc({ tagName: e, ...a }),
        d = f;
      return b.exports.jsx(d, {
        ...c,
        ...a,
        ref: i,
        className: q(
...
at.defaultProps = mE;
const hE = window.location.origin;
function vE(e, t = {}) {
  const n = new URL(e, hE);
...
function EE(e, t) {
  const n = e
    ...
    .join("/");
  return sn(`api/explist/${n}/${encodeURIComponent(t)}/arginfo`);
}
function $h() {
  return sn("api/datasets/names");
}
function yo(e) {
  const t = Array.isArray(e) ? e.join(",") : e;
  return sn("api/datasets/values", { params: { names: t } });
}
function wE() {
  return sn("api/health");
}
function SE() {
  return sn("api/logs");
}
...
function RE(e) {
  return (e && NE[e]) || "is-pending";
}
function OE({ status: e }) {
  return s.createElement(
    "span",
    { className: `status-pill ${RE(e)}`, "aria-label": `Status: ${e}` },
    e,
  );
}
function _E({ rid: e, className: t, file: n, status: r }) {
  return s.createElement(
    "div",
...
function PE(e) {
  ...
  return s.createElement(
    ...
    s.createElement(
      ft.Header,
      null,
      s.createElement(_E, { rid: t, className: n, file: r, status: l }),
    ),
    s.createElement(
      ft.Body,
      null,
      ...
      s.createElement(
        tc,
        { className: "mt-3" },
        s.createElement(kE, { rid: t }),
        s.createElement(CE, { rid: t }),
      ),
    ),
  );
}
  ...
  return (
    ...
    Object.keys(e).length === 0
      ...
      : s.createElement(
          ...
          Object.keys(e).map((n) =>
            s.createElement(PE, { key: n, rid: n, data: e[n] }),
          ),
        )
  );
}
  ...
  if (
    ...
    return s.createElement(
      "div",
      {
        ...
        tabIndex: 0,
        onKeyDown: (m) => {
          (m.key === "Enter" || m.key === " ") && (m.preventDefault(), a(e));
        },
      },
      s.createElement(
        "span",
        { className: "experiment-item__icon", "aria-hidden": "true" },
        s.createElement(Px, { size: 14 }),
      ),
      s.createElement(
        "span",
      ...
      s.createElement("span", { className: "experiment-item__file" }, x.file),
    );
  }
    ...
    : s.createElement(
        ...
        s.createElement(
          ...
          s.createElement(
            ...
            s.createElement(Ju, { size: 12 }),
          ),
          s.createElement(
            "span",
            { className: "experiment-folder__icon", "aria-hidden": "true" },
            s.createElement(Lx, { size: 14 }),
          ),
...
var ME = /-(.)/g;
function DE(e) {
  return e.replace(ME, function (t, n) {
    return n.toUpperCase();
  });
}
const IE = (e) => e[0].toUpperCase() + DE(e).slice(1);
function je(e, { displayName: t = IE(e), Component: n, defaultProps: r } = {}) {
  const o = p.exports.forwardRef(
    ({ className: l, bsPrefix: a, as: i = n || "div", ...u }, c) => {
      const f = Z(a, e);
      return b.exports.jsx(i, { ref: c, className: q(l, f), ...u });
    },
  );
...
const Ua = (e) =>
    p.exports.forwardRef((t, n) =>
      b.exports.jsx("div", { ...t, ref: n, className: q(t.className, e) }),
    ),
  Lh = p.exports.forwardRef(
    ({ bsPrefix: e, className: t, variant: n, as: r = "img", ...o }, l) => {
      const a = Z(e, "card-img");
      return b.exports.jsx(r, {
        ref: l,
        className: q(n ? `${a}-${n}` : a, t),
        ...o,
      });
    },
  );
Lh.displayName = "CardImg";
const jh = p.exports.createContext(null);
jh.displayName = "CardHeaderContext";
const Mh = p.exports.forwardRef(
  ({ bsPrefix: e, className: t, as: n = "div", ...r }, o) => {
    const l = Z(e, "card-header"),
      a = p.exports.useMemo(() => ({ cardHeaderBsPrefix: l }), [l]);
    return b.exports.jsx(jh.Provider, {
      value: a,
      children: b.exports.jsx(n, { ref: o, ...r, className: q(t, l) }),
    });
  },
);
Mh.displayName = "CardHeader";
const zE = Ua("h5"),
  FE = Ua("h6"),
  Dh = je("card-body"),
  AE = je("card-title", { Component: zE }),
  BE = je("card-subtitle", { Component: FE }),
  WE = je("card-link", { Component: "a" }),
  UE = je("card-text", { Component: "p" }),
  VE = je("card-footer"),
  HE = je("card-img-overlay"),
  KE = { body: !1 },
  rc = p.exports.forwardRef(
    (
      ...
      return b.exports.jsx(i, {
        ...
        children: l ? b.exports.jsx(Dh, { children: a }) : a,
      });
    },
  );
rc.displayName = "Card";
rc.defaultProps = KE;
const ot = Object.assign(rc, {
  Img: Lh,
  Title: AE,
  Subtitle: BE,
  Body: Dh,
      ...
      return b.exports.jsx(lh, {
        ...
        children: (a, i) =>
          p.exports.cloneElement(t, {
            ...i,
            className: q("fade", e, t.props.className, qE[a], n[a]),
          }),
      });
    },
  );
un.defaultProps = GE;
un.displayName = "Fade";
const YE = { [jt]: "showing", [Ao]: "showing show" },
  Fh = p.exports.forwardRef((e, t) =>
    b.exports.jsx(un, { ...e, ref: t, transitionClasses: YE }),
  );
Fh.displayName = "ToastFade";
function XE(e) {
  var t = p.exports.useRef(e);
  return (
    p.exports.useEffect(
...
const JE = {
    ...
    variant: O.exports.oneOf(["white"]),
  },
  ZE = { "aria-label": "Close" },
  Vr = p.exports.forwardRef(({ className: e, variant: t, ...n }, r) =>
    b.exports.jsx("button", {
      ref: r,
      type: "button",
...
Vr.propTypes = JE;
Vr.defaultProps = ZE;
const Ah = p.exports.createContext({ onClose() {} }),
  ew = { closeLabel: "Close", closeButton: !0 },
  ac = p.exports.forwardRef(
    (
      {
        bsPrefix: e,
        closeLabel: t,
      ...
      e = Z(e, "toast-header");
      const u = p.exports.useContext(Ah),
        c = Ke((f) => {
          u == null || u.onClose == null || u.onClose(f);
        });
      return b.exports.jsxs("div", {
        ref: i,
        ...a,
        className: q(e, o),
        children: [
...
ac.displayName = "ToastHeader";
ac.defaultProps = ew;
const tw = je("toast-body"),
  Bh = p.exports.forwardRef(
    (
      {
        bsPrefix: e,
        className: t,
      ...
      const d = p.exports.useRef(l),
        v = p.exports.useRef(i);
      p.exports.useEffect(() => {
        (d.current = l), (v.current = i);
      }, [l, i]);
      const y = zh(),
        x = !!(a && r),
        w = p.exports.useCallback(() => {
      ...
      const k = p.exports.useMemo(() => ({ onClose: i }), [i]),
        ...
        h = b.exports.jsx("div", {
          ...c,
          ref: f,
          className: q(e, t, u && `bg-${u}`, !m && (r ? "show" : "hide")),
          role: "alert",
          "aria-live": "assertive",
          "aria-atomic": "true",
        });
      return b.exports.jsx(Ah.Provider, {
        value: k,
        children:
          m && n
            ? b.exports.jsx(n, { in: r, unmountOnExit: !0, children: h })
            : h,
      });
    },
  );
Bh.displayName = "Toast";
const Nr = Object.assign(Bh, { Body: tw, Header: ac }),
  nw = {
  ...
  sc = p.exports.forwardRef(
    (
      ...
      (e = Z(e, "toast-container")),
      b.exports.jsx(o, {
        ref: a,
        ...l,
        className: q(e, t && [n ? `position-${n}` : null, nw[t]], r),
      })
    ),
  );
sc.displayName = "ToastContainer";
const rw = {
    type: O.exports.string,
    tooltip: O.exports.bool,
    as: O.exports.elementType,
  },
...
Va.propTypes = rw;
const tn = p.exports.createContext({}),
  tl = p.exports.forwardRef(
    (
      ...
      const { controlId: c } = p.exports.useContext(tn);
      return (
        ...
        b.exports.jsx(a, {
          ...
          type: r,
          id: e || c,
          className: q(n, t, o && "is-valid", l && "is-invalid"),
        })
      );
    },
  );
...
const ha = p.exports.forwardRef(
  ({ bsPrefix: e, className: t, htmlFor: n, ...r }, o) => {
    const { controlId: l } = p.exports.useContext(tn);
    return (
...
const Wh = p.exports.forwardRef(
  (
    ...
    const { controlId: E } = p.exports.useContext(tn),
      S = p.exports.useMemo(() => ({ controlId: e || E }), [E, e]),
      N = (!k && w != null && w !== !1) || ow(k, ha),
      C = b.exports.jsx(tl, {
        ...h,
    ...
    return b.exports.jsx(tn.Provider, {
      value: S,
      children: b.exports.jsx("div", {
        style: v,
        className: q(
          d,
          N && t,
        ...
        children:
          k ||
          b.exports.jsxs(b.exports.Fragment, {
            children: [
              C,
              N && b.exports.jsx(ha, { title: y, children: w }),
              c && b.exports.jsx(Va, { type: f, tooltip: u, children: c }),
            ],
          }),
      }),
    });
...
Wh.displayName = "FormCheck";
const va = Object.assign(Wh, { Input: tl, Label: ha }),
  Uh = p.exports.forwardRef(
    (
      {
        bsPrefix: e,
        type: t,
      ...
      const { controlId: y } = p.exports.useContext(tn);
      e = Z(e, "form-control");
      let x;
      return (
        u
...
Uh.displayName = "FormControl";
const lw = Object.assign(Uh, { Feedback: Va }),
  aw = je("form-floating"),
  ic = p.exports.forwardRef(({ controlId: e, as: t = "div", ...n }, r) => {
    const o = p.exports.useMemo(() => ({ controlId: e }), [e]);
    return b.exports.jsx(tn.Provider, {
      value: o,
      children: b.exports.jsx(t, { ...n, ref: r }),
    });
  });
ic.displayName = "FormGroup";
const sw = { column: !1, visuallyHidden: !1 },
  uc = p.exports.forwardRef(
    (
      {
        as: e = "label",
        bsPrefix: t,
      ...
      const { controlId: u } = p.exports.useContext(tn);
      t = Z(t, "form-label");
      let c = "col-form-label";
      typeof n == "string" && (c = `${c} ${c}-${n}`);
      const f = q(o, t, r && "visually-hidden", n && c);
      return (
        (l = l || u),
        n
          ? b.exports.jsx(He, {
          ...
          : b.exports.jsx(e, { ref: i, className: f, htmlFor: l, ...a })
      );
    },
  );
uc.displayName = "FormLabel";
uc.defaultProps = sw;
...
Vh.displayName = "FormRange";
const Hh = p.exports.forwardRef(
  (
    {
      bsPrefix: e,
      size: t,
...
Hh.displayName = "FormSelect";
const Kh = p.exports.forwardRef(
  ({ bsPrefix: e, className: t, as: n = "small", muted: r, ...o }, l) => (
    (e = Z(e, "form-text")),
    b.exports.jsx(n, { ...o, ref: l, className: q(t, e, r && "text-muted") })
  ),
);
Kh.displayName = "FormText";
const Qh = p.exports.forwardRef((e, t) =>
  b.exports.jsx(va, { ...e, ref: t, type: "switch" }),
);
Qh.displayName = "Switch";
const iw = Object.assign(Qh, { Input: va.Input, Label: va.Label }),
  Gh = p.exports.forwardRef(
    (
      ...
      b.exports.jsxs(ic, {
        ...
        controlId: r,
        ...l,
        children: [n, b.exports.jsx("label", { htmlFor: r, children: o })],
      })
    ),
  );
Gh.displayName = "FloatingLabel";
const uw = {
    _ref: O.exports.any,
    validated: O.exports.bool,
    as: O.exports.elementType,
  },
  cc = p.exports.forwardRef(
    ({ className: e, validated: t, as: n = "form", ...r }, o) =>
      b.exports.jsx(n, { ...r, ref: o, className: q(e, t && "was-validated") }),
  );
cc.displayName = "Form";
cc.propTypes = uw;
const X = Object.assign(cc, {
  Group: ic,
  Control: lw,
  Floating: aw,
  Check: va,
...
const Xh = p.exports.createContext(null);
Xh.displayName = "InputGroupContext";
const dc = je("input-group-text", { Component: "span" }),
  gw = (e) =>
    b.exports.jsx(dc, {
      children: b.exports.jsx(tl, { type: "checkbox", ...e }),
    }),
  yw = (e) =>
    b.exports.jsx(dc, { children: b.exports.jsx(tl, { type: "radio", ...e }) }),
  Jh = p.exports.forwardRef(
    (
      {
        bsPrefix: e,
        size: t,
      ...
      return b.exports.jsx(Xh.Provider, {
        value: i,
        children: b.exports.jsx(o, {
          ref: a,
          ...l,
          className: q(r, e, t && `${e}-${t}`, n && "has-validation"),
        }),
      });
    },
  );
Jh.displayName = "InputGroup";
const me = Object.assign(Jh, { Text: dc, Radio: yw, Checkbox: gw });
function Bo(e, t) {
...
function Zf(e, t, n) {
  for (n of e.keys()) if (xo(n, t)) return n;
}
function xo(e, t) {
  var n, r, o;
  if (e === t) return !0;
  if (e && t && (n = e.constructor) === t.constructor) {
    ...
    if (n === Array) {
      if ((r = e.length) === t.length) for (; r-- && xo(e[r], t[r]); );
      return r === -1;
    }
    if (n === Set) {
      ...
      for (r of e)
        if (
          ((o = r),
          (o && typeof o == "object" && ((o = Zf(t, o)), !o)) || !t.has(o))
        )
          return !1;
      return !0;
    }
...
var tt = "top",
  ...
  no = "popper",
  ww = "reference",
  ed = nl.reduce(function (e, t) {
    return e.concat([t + "-" + Lr, t + "-" + Wo]);
  }, []),
  ev = [].concat(nl, [pc]).reduce(function (e, t) {
    return e.concat([t, t + "-" + Lr, t + "-" + Wo]);
  }, []),
  Sw = "beforeRead",
  kw = "read",
  Cw = "afterRead",
...
function Ha(e) {
  return bn(e) === "html"
    ? e
    : e.assignedSlot || e.parentNode || (mc(e) ? e.host : null) || Mn(e);
}
function td(e) {
  return !At(e) || nn(e).position === "fixed" ? null : e.offsetParent;
}
function Lw(e) {
  var t = /firefox/i.test(Wi()),
    n = /Trident/i.test(Wi());
  if (n && At(e)) {
    var r = nn(e);
  ...
  var o = Ha(e);
  for (mc(o) && (o = o.host); At(o) && ["html", "body"].indexOf(bn(o)) < 0; ) {
    var l = nn(o);
    if (
      l.transform !== "none" ||
      l.perspective !== "none" ||
...
function rl(e) {
  for (var t = kt(e), n = td(e); n && $w(n) && nn(n).position === "static"; )
    n = td(n);
  return n &&
    (bn(n) === "html" || (bn(n) === "body" && nn(n).position === "static"))
    ? t
    : n || Lw(e) || t;
}
function vc(e) {
...
function Dw(e) {
  ...
  if (!(!l || !a)) {
    var d = Mw(o.padding, n),
      ...
      m = rl(l),
      h = m ? (u === "y" ? m.clientHeight || 0 : m.clientWidth || 0) : 0,
      g = w / 2 - k / 2,
      E = d[y],
      S = h - v[f] - d[x],
      N = h / 2 - v[f] / 2 + g,
      C = Eo(E, N, S),
      R = u;
    n.modifiersData[r] = ((t = {}), (t[R] = C), (t.centerOffset = C - N), t);
  }
}
function Iw(e) {
  var t = e.state,
...
var Fw = { top: "auto", right: "auto", bottom: "auto", left: "auto" };
function Aw(e) {
  var t = e.x,
    n = e.y,
    r = window,
...
function nd(e) {
  ...
  if (c) {
    ...
    if (
      ...
      E = Et;
      var $ = d && N === S && S.visualViewport ? S.visualViewport.height : N[C];
      (w -= $ - r.height), (w *= u ? 1 : -1);
    }
    if (o === nt || ((o === tt || o === Et) && l === Wo)) {
      g = wt;
      var j = d && N === S && S.visualViewport ? S.visualViewport.width : N[R];
      (y -= j - r.width), (y *= u ? 1 : -1);
    }
  }
  var I = Object.assign({ position: i }, c && Fw),
    K = f === !0 ? Aw({ x: y, y: w }) : { x: y, y: w };
  if (((y = K.x), (w = K.y), u)) {
    var G;
...
var Hw = { left: "right", right: "left", bottom: "top", top: "bottom" };
function Al(e) {
  return e.replace(/left|right|bottom|top/g, function (t) {
    return Hw[t];
  });
}
var Kw = { start: "end", end: "start" };
function rd(e) {
...
function yc(e) {
  return Mr(Mn(e)).left + gc(e).scrollLeft;
}
function Qw(e, t) {
  var n = kt(e),
    r = Mn(e),
  ...
  return { width: l, height: a, x: i + yc(e), y: u };
}
function Gw(e) {
  var t,
    n = Mn(e),
...
function wo(e, t) {
  ...
  var r = av(e),
    ...
    l = kt(r),
    a = o ? [l].concat(l.visualViewport || [], xc(r) ? r : []) : r,
    i = t.concat(a);
  return o ? i : i.concat(wo(Ha(a)));
}
function Ui(e) {
...
function od(e, t, n) {
  return t === Zh ? Ui(Qw(e, n)) : Jn(t) ? qw(t, n) : Ui(Gw(Mn(e)));
}
function Yw(e) {
  var t = wo(Ha(e)),
    n = ["absolute", "fixed"].indexOf(nn(e).position) >= 0,
    r = n && At(e) ? rl(e) : e;
  return Jn(r)
    ? t.filter(function (o) {
        return Jn(o) && nv(o, r) && bn(o) !== "body";
      })
    : [];
}
function Xw(e, t, n, r) {
  var o = t === "clippingParents" ? Yw(e) : [].concat(t),
    l = [].concat(o, [n]),
    a = l[0],
    i = l.reduce(
      function (u, c) {
...
function Uo(e, t) {
  ...
  var n = t,
    ...
    w = n.padding,
    k = w === void 0 ? 0 : w,
    m = ov(typeof k != "number" ? k : lv(k, nl)),
    h = v === no ? ww : no,
    g = e.rects.popper,
    E = e.elements[x ? h : v],
    S = Xw(Jn(E) ? E : E.contextElement || Mn(e.elements.popper), u, f, a),
    N = Mr(e.elements.reference),
    C = sv({ reference: N, element: g, strategy: "absolute", placement: o }),
    R = Ui(Object.assign({}, g, C)),
    $ = v === no ? R : N,
    j = {
      top: S.top - $.top + m.top,
  ...
  if (v === no && I) {
    ...
    Object.keys(j).forEach(function (G) {
      var T = [wt, Et].indexOf(G) >= 0 ? 1 : -1,
        F = [tt, Et].indexOf(G) >= 0 ? "y" : "x";
      j[G] += K[F] * T;
    });
  }
  return j;
...
function Jw(e, t) {
  ...
  var y = v.reduce(function (x, w) {
    return (
      (x[w] = Uo(e, { placement: w, boundary: o, rootBoundary: l, padding: a })[
        Ft(w)
      ]),
      x
    );
  ...
  if (!t.modifiersData[r]._skip) {
    for (
      var o = n.mainAxis,
        ...
        h = m === k,
        g = u || (h || !x ? [Al(k)] : Zw(k)),
        E = [k].concat(g).reduce(function (U, H) {
          return U.concat(
            Ft(H) === pc
              ? Jw(t, {
                  placement: H,
...
function ad(e) {
  return [tt, wt, Et, nt].some(function (t) {
    return e[t] >= 0;
  });
}
function nS(e) {
...
function oS(e, t, n) {
  ...
  return (
    (a = a || 0),
    (i = (i || 0) * o),
    [nt, wt].indexOf(r) >= 0 ? { x: i, y: a } : { x: a, y: i }
  );
}
function lS(e) {
  var t = e.state,
    ...
    o = n.offset,
    l = o === void 0 ? [0, 0] : o,
    a = ev.reduce(function (f, d) {
      return (f[d] = oS(d, t.rects, l)), f;
    }, {}),
    i = a[t.placement],
    u = i.x,
    c = i.y;
...
function cS(e) {
  var t = e.state,
    ...
    x = n.tetherOffset,
    w = x === void 0 ? 0 : x,
    k = Uo(t, { boundary: u, rootBoundary: c, padding: d, altBoundary: f }),
    m = Ft(t.placement),
    h = Dr(t.placement),
    g = !h,
    E = vc(m),
  ...
  if (!!N) {
    if (l) {
      var G,
        ...
        J = H[F],
        ie = Eo(0, C[V], U[V]),
        te = g ? C[V] / 2 - L - ie - Q - j.mainAxis : A - ie - Q - j.mainAxis,
        ce = g ? -C[V] / 2 + L + ie + J + j.mainAxis : W + ie + J + j.mainAxis,
        Ne = t.elements.arrow && rl(t.elements.arrow),
        Me = Ne ? (E === "y" ? Ne.clientTop || 0 : Ne.clientLeft || 0) : 0,
        D = (G = I == null ? void 0 : I[E]) != null ? G : 0,
        ee = Y + te - D - Me,
        ae = Y + ce - D,
        ne = Eo(y ? xa(_, ee) : _, Y, y ? Kn(z, ae) : z);
      (N[E] = ne), (K[E] = ne - Y);
    }
    if (i) {
      var Ee,
        ...
        We = _e + k[fe],
        cn = _e - k[re],
        fn = [tt, nt].indexOf(m) !== -1,
        le = (Ee = I == null ? void 0 : I[S]) != null ? Ee : 0,
        Bt = fn ? We : _e - C[Be] - R[Be] - le + j.altAxis,
        Hr = fn ? _e + C[Be] + R[Be] - le - j.altAxis : cn,
        Tc = y && fn ? jw(Bt, _e, Hr) : Eo(y ? Bt : We, _e, y ? Hr : cn);
      (N[S] = Tc), (K[S] = Tc - _e);
    }
    t.modifiersData[r] = K;
  }
    ...
    var f = {
      ...
      y = {
        ...
        setOptions: function (m) {
          var h = typeof m == "function" ? m(f.options) : m;
          w(),
            (f.options = Object.assign({}, l, f.options, h)),
            (f.scrollParents = {
              reference: Jn(i)
                ? wo(i)
                : i.contextElement
          ...
          var g = gS(xS([].concat(r, f.options.modifiers)));
          return (
            (f.orderedModifiers = g.filter(function (E) {
              return E.enabled;
            })),
            x(),
            y.update()
        ...
        forceUpdate: function () {
          if (!v) {
            ...
            if (!!id(h, g)) {
              (f.rects = {
                reference: hS(h, rl(g), f.options.strategy === "fixed"),
                popper: hc(g),
              }),
                (f.reset = !1),
              ...
              for (var E = 0; E < f.orderedModifiers.length; E++) {
                ...
                var S = f.orderedModifiers[E],
                  N = S.fn,
                  C = S.options,
                  R = C === void 0 ? {} : C,
                  $ = S.name;
                typeof N == "function" &&
                  (f = N({ state: f, options: R, name: $, instance: y }) || f);
              }
            }
          }
        },
    ...
    function x() {
      f.orderedModifiers.forEach(function (k) {
        ...
        if (typeof E == "function") {
          var S = E({ state: f, name: m, instance: y, options: g }),
            N = function () {};
          d.push(S || N);
        }
      });
...
const wS = ES({ defaultModifiers: [rS, iS, Ww, Vw, aS, tS, fS, zw] }),
...
function OS(e, t, n = {}) {
  ...
  const u = p.exports.useRef(a),
      ...
      () => ({
        ...
        fn: ({ state: k }) => {
          ...
          Object.keys(k.elements).forEach((g) => {
            (m[g] = k.styles[g]), (h[g] = k.attributes[g]);
          }),
            y({
              state: k,
              styles: m,
    ...
    w = p.exports.useMemo(
      () => (xo(u.current, a) || (u.current = a), u.current),
      [a],
    );
  return (
    p.exports.useEffect(() => {
...
const Bl = (e) => e && ("current" in e ? e.current : e),
  cd = { click: "mousedown", mouseup: "mousedown", pointerup: "pointerdown" };
function TS(e, t = ud, { disabled: n, clickTrigger: r = "click" } = {}) {
  const o = p.exports.useRef(!1),
    l = p.exports.useRef(!1),
    a = p.exports.useCallback(
      (c) => {
        const f = Bl(e);
        (o.current = !f || PS(c) || !_S(c) || !!Bo(f, c.target) || l.current),
          (l.current = !1);
      },
      [e],
    ),
  ...
  p.exports.useEffect(() => {
    ...
    return (
      "ontouchstart" in c.documentElement &&
        (x = [].slice.call(c.body.children).map((w) => Kt(w, "mousemove", ud))),
      () => {
...
const bS = 27,
  $S = () => {};
function LS(e, t, { disabled: n, clickTrigger: r } = {}) {
  const o = t || $S;
  TS(e, o, { disabled: n, clickTrigger: r });
  const l = Ke((a) => {
    a.keyCode === bS && o(a);
  });
  p.exports.useEffect(() => {
...
const iv = p.exports.createContext(Ur ? window : void 0);
iv.Provider;
function uv() {
  return p.exports.useContext(iv);
}
const ks = (e, t) =>
  Ur
    ? e == null
...
function Vi(e, t) {
  const n = uv(),
    [r, o] = p.exports.useState(() => ks(e, n == null ? void 0 : n.document));
  if (!r) {
    const l = ks(e);
    l && o(l);
  }
...
const cv = p.exports.forwardRef((e, t) => {
  const {
      flip: n,
      offset: r,
      placement: o,
  ...
  return y ? Un.createPortal(E, y) : null;
});
cv.displayName = "Overlay";
var IS =
    typeof global < "u" &&
    global.navigator &&
    global.navigator.product === "ReactNative",
  zS = typeof document < "u";
const FS = zS || IS ? p.exports.useLayoutEffect : p.exports.useEffect;
function fv(e, t) {
  return e.classList
...
const BS = { placement: "right" },
  mv = p.exports.forwardRef(
    (
      {
        bsPrefix: e,
        placement: t,
      ...
      return b.exports.jsxs("div", {
        ...
        style: r,
        "x-placement": y,
        className: q(n, d, y && `bs-popover-${x}`),
        ...c,
        children: [
          b.exports.jsx("div", { className: "popover-arrow", ...a }),
          l ? b.exports.jsx(dv, { children: o }) : o,
        ],
      });
    },
  );
mv.defaultProps = BS;
const WS = Object.assign(mv, { Header: AS, Body: dv, POPPER_OFFSET: [0, 8] });
function US(e) {
  const t = p.exports.useRef(null),
    ...
    r = p.exports.useMemo(
      () => ({
        ...
        options: {
          offset: () =>
            t.current && fv(t.current, n) ? e || WS.POPPER_OFFSET : e || [0, 0],
        },
      }),
      [e, n],
    );
...
const VS = { transition: un, rootClose: !1, show: !1, placement: "top" };
function HS(e, t) {
  const { ref: n } = e,
    { ref: r } = t;
    ...
    return (
      ...
      b.exports.jsx(cv, {
        ...
        children: (y, { arrowProps: x, popper: w, show: k }) => {
          var m, h;
          HS(y, x);
          const g = w == null ? void 0 : w.placement,
            E = Object.assign(l.current, {
              ...
              outOfBoundaries:
                (w == null ||
                (m = w.state) == null ||
                (h = m.modifiersData.hide) == null
                  ? void 0
                  : h.isReferenceHidden) || !1,
            });
          return typeof e == "function"
            ...
            : p.exports.cloneElement(e, {
                ...
                arrowProps: x,
                popper: E,
                className: q(e.props.className, !t && k && "show"),
...
function wc({
  ...
  const d = p.exports.useRef(null),
    ...
    T = { ref: S };
  return (
    G.indexOf("click") !== -1 && (T.onClick = j),
    G.indexOf("focus") !== -1 && ((T.onFocus = R), (T.onBlur = $)),
    G.indexOf("hover") !== -1 && ((T.onMouseOver = I), (T.onMouseOut = K)),
    b.exports.jsxs(b.exports.Fragment, {
      children: [
        typeof n == "function" ? n(T) : p.exports.cloneElement(n, T),
        b.exports.jsx(Ec, {
          ...f,
          show: w,
          onHide: C,
  ...
  Ka = p.exports.forwardRef(
    (
      ...
      return b.exports.jsxs("div", {
        ...
        role: "tooltip",
        "x-placement": d,
        className: q(n, e, `bs-tooltip-${v}`),
        ...u,
        children: [
          b.exports.jsx("div", { className: "tooltip-arrow", ...l }),
          b.exports.jsx("div", { className: `${e}-inner`, children: o }),
        ],
      });
    },
  );
...
function Dn({ onClick: e, disabled: t }) {
  return s.createElement(
    wc,
    {
      placement: "top",
      overlay: s.createElement(Ka, null, "Reset to default"),
    },
    s.createElement(
      at,
...
function qS({ name: e, spec: t, value: n, onChange: r, onReset: o }) {
  const {
      unit: l,
      scale: a,
      step: i,
  ...
  return s.createElement(
    ...
    l && s.createElement(me.Text, null, l),
    s.createElement(Dn, { onClick: () => o(e), disabled: y }),
  );
}
function YS({ name: e, spec: t, value: n, onChange: r, onReset: o }) {
  ...
  return s.createElement(
    ...
    s.createElement(Dn, { onClick: () => o(e), disabled: i }),
  );
}
function XS({ name: e, spec: t, value: n, onChange: r, onReset: o }) {
  ...
  return s.createElement(
    ...
    s.createElement(Dn, { onClick: () => o(e), disabled: a }),
  );
}
...
function ek({ schema: e, value: t, onChange: n, onReset: r, disabled: o }) {
  const { fqn: l, default: a, spec: i } = e,
    { unit: u, scale: c, step: f, min: d, max: v } = i || {},
    y = a ? parseFloat(a) : 0,
    x = t != null ? t : y,
    w = Dt(x, c),
    k = t == null,
  ...
  return s.createElement(
    ...
    u && s.createElement(me.Text, null, u),
    o &&
      s.createElement(
        me.Text,
    ...
    s.createElement(Dn, { onClick: () => r(l), disabled: k || o }),
  );
}
function tk({ schema: e, value: t, onChange: n, onReset: r, disabled: o }) {
  const { fqn: l, default: a, spec: i } = e,
    { unit: u, scale: c, step: f, min: d, max: v } = i || {},
    y = a ? parseInt(a) : 0,
    x = t != null ? t : y,
    ...
    m = (S) => {
      const N = S.target.value,
        C = ga(N, c),
        R = typeof C == "number" ? Math.round(C) : C;
      n(l, R);
    },
    h = Dt(d, c),
    g = Dt(v, c),
...
function nk({ schema: e, value: t, onChange: n, onReset: r, disabled: o }) {
  ...
  return s.createElement(
    ...
    s.createElement(Dn, { onClick: () => r(l), disabled: d || o }),
  );
}
function rk(e) {
  switch (e) {
...
function ok({ name: e, argInfo: t, value: n, onChange: r, onReset: o }) {
  const [l, a, i] = t,
    u = rk(l.ty),
    c = s.createElement(
      X.Label,
  ...
  return s.createElement(
    ...
    s.createElement(
      ...
      i
        ? s.createElement(
            wc,
            { placement: "right", overlay: s.createElement(Ka, null, i) },
            s.createElement(
              "span",
...
function sk(e) {
  const t = e.data.name,
    ...
    [i, u] = s.useState(() => {
      var R;
      const C = Hi(n, r);
      return (R = C == null ? void 0 : C.argValues) != null ? R : a;
    }),
    [c, f] = s.useState(() => {
      var R;
      const C = Hi(n, r);
      return (R = C == null ? void 0 : C.pipeline) != null ? R : "main";
    }),
    [d, v] = s.useState(!1),
    [y, x] = s.useState("");
  s.useEffect(() => {
    vv(n, r, { argValues: i, pipeline: c });
  }, [n, r, i, c]);
  const w = s.useMemo(() => ak(o), [o]),
  ...
  return s.createElement(
    ...
    s.createElement(
      ...
      s.createElement(
        X.Group,
        { className: "mt-4 mb-3" },
        s.createElement(X.Label, null, "Pipeline"),
        s.createElement(X.Control, {
          type: "text",
          value: c,
...
Sc.displayName = "Badge";
Sc.defaultProps = ik;
function uk({ scan: e, schemata: t, onChange: n }) {
  const {
      axes: r = [],
      num_repeats: o = 1,
    ...
    u = s.useMemo(
      () =>
        t ? Object.values(t).filter((S) => S.spec && S.spec.is_scannable) : [],
      [t],
    ),
    c = new Set(r.map((S) => S.fqn).filter(Boolean)),
    f = () => {
      const S = {
        fqn: "",
        path: "",
    ...
    v = (S, N, C) => {
      ...
      if (N === "fqn") {
        const $ = t[C];
        R[S] = { ...R[S], fqn: C, path: $ ? y() : "" };
      } else if (N.startsWith("range.")) {
        const $ = N.split(".")[1];
        R[S] = { ...R[S], range: { ...R[S].range, [$]: C } };
      } else R[S] = { ...R[S], [N]: C };
      n({ ...e, axes: R });
    },
    y = (S) => "",
    ...
    w = (S) => {
      n({ ...e, num_repeats: S ? 2147483647 : 1 });
    },
    k = (S) => {
      n({ ...e, no_axes_mode: S });
    },
    m = (S) => {
      n({ ...e, randomise_order_globally: S });
    },
    h = (S) => {
      n({ ...e, skip_on_persistent_transitory_error: S });
    },
    g = s.useMemo(
      () =>
        r.length === 0
          ...
          : r.reduce((S, N) => {
              var R;
              const C = ((R = N.range) == null ? void 0 : R.num_points) || 1;
              return S * C;
            }, 1) * o,
      [r, o],
    ),
            ...
            const C = S.fqn ? t[S.fqn] : null,
              ...
              $ =
                ((G = C == null ? void 0 : C.spec) == null
                  ? void 0
                  : G.scale) || 1,
              j = Dt((T = S.range) == null ? void 0 : T.start, $),
              I = Dt((F = S.range) == null ? void 0 : F.stop, $);
            return s.createElement(
              ot,
                  ...
                  s.createElement(
                    ...
                    s.createElement(
                      X.Select,
                      {
                        size: "sm",
                        value: S.fqn || "",
                        onChange: (_) => v(N, "fqn", _.target.value),
                      },
                      s.createElement(
                        "option",
                        { value: "" },
                      ...
                      u.map((_) =>
                        s.createElement(
                          "option",
                          {
                            key: _.fqn,
                            value: _.fqn,
                            disabled: c.has(_.fqn) && S.fqn !== _.fqn,
                          },
                          _.description || _.fqn,
                        ),
                      ),
                ...
                s.createElement(
                  ...
                  s.createElement(
                    ...
                    s.createElement(
                      ...
                      s.createElement(X.Control, {
                        ...
                        value: j,
                        onChange: (_) => {
                          const z = ga(_.target.value, $);
                          v(N, "range.start", z);
                        },
                        step: "any",
                      }),
                      R && s.createElement(me.Text, null, R),
                    ),
                  ),
                  s.createElement(
                    He,
                  ...
                  s.createElement(
                    ...
                    s.createElement(X.Control, {
                      ...
                      size: "sm",
                      value:
                        ((V = S.range) == null ? void 0 : V.num_points) || 11,
                      onChange: (_) =>
                        v(N, "range.num_points", parseInt(_.target.value)),
                      min: "1",
                      step: "1",
                    }),
                  ),
                ),
                s.createElement(X.Check, {
                  type: "checkbox",
                  className: "mt-2",
                  label: "Randomize order (this axis)",
                  checked:
                    ((Y = S.range) == null ? void 0 : Y.randomise_order) || !1,
                  onChange: (_) =>
                    v(N, "range.randomise_order", _.target.checked),
                }),
              ),
            );
          }),
        ...
        s.createElement(
          ...
          s.createElement(
            ...
            s.createElement(X.Control, {
              type: "number",
              value: E ? "" : o,
              onChange: (S) => x(parseInt(S.target.value) || 1),
              min: "1",
              step: "1",
              disabled: E,
              placeholder: E ? "Infinite" : "",
            }),
            s.createElement(me.Checkbox, {
              checked: E,
              onChange: (S) => w(S.target.checked),
            }),
            s.createElement(me.Text, null, "Infinite"),
          ),
        ),
        s.createElement(
          He,
          { md: 6 },
          s.createElement(X.Label, { className: "mb-1 small" }, "No-Axes Mode"),
          s.createElement(
            X.Select,
            { size: "sm", value: l, onChange: (S) => k(S.target.value) },
...
function ck(e) {
  ...
  s.useEffect(() => {
    if (a) {
      const P = mw(n, r);
      (() =>
        (a.always_shown || []).map((H) =>
          H && H.__jsonclass__ && H.__jsonclass__[0] === "tuple"
            ? H.__jsonclass__[1][0][0]
            : (console.error("Unexpected always_shown item format:", H), ""),
        ))(),
        P && P.visibleFqns ? y(new Set(P.visibleFqns)) : y(new Set()),
        P ? (c(P.overrides || {}), d(P.scan || a.scan)) : (c({}), d(a.scan));
    }
  }, [a, n, r]),
    s.useEffect(() => {
      f &&
  ...
  const j = s.useMemo(() => (a ? dw(a.instances) : {}), [a]),
    I = s.useMemo(() => (f ? pw(f) : new Set()), [f]),
    K = (P, U) => {
      c((H) => ({ ...H, [P]: U }));
    },
    G = (P) => {
    ...
    F = () => {
      a && (c({}), d(a.scan), localStorage.removeItem(fc(n, r)));
    },
    V = (P) => {
      S(P), g(!0);
    },
    Y = (P, U) =>
      s.createElement(
        "tr",
        { key: P },
        s.createElement("td", null, s.createElement("b", null, P, ":")),
        s.createElement("td", null, U),
      ),
    _ = (P, U) => {
      const { description: H, type: Q } = U,
        J = I.has(P),
        ie = u[P];
      let te;
      if (Q === "float") te = ek;
      else if (Q === "int") te = tk;
      else if (Q === "bool") te = nk;
      else return null;
      return s.createElement(
        X.Group,
        { key: P, className: "mb-2 row align-items-center" },
        s.createElement(
          "div",
          { className: "col-4" },
          s.createElement(
    ...
    z = () => {
      if (a) {
        const P = new Set(Object.keys(u)),
          U = [...I].filter((H) => P.has(H));
        return U.length > 0
          ? (V(
              `Parameters cannot be both overridden and scanned: ${U.join(
                ", ",
              )}`,
            ),
            null)
  ...
  if (!a) return null;
  const L = (a.always_shown || []).map((P) =>
      Array.isArray(P)
        ? P[0]
        : P && P.__jsonclass__ && P.__jsonclass__[0] === "tuple"
          ? P.__jsonclass__[1][0][0]
          : P,
    ),
    A = new Set([...(x ? L : []), ...v]),
    W = k
      ? Object.entries(i).filter(
          ([P, U]) =>
            ...
            (U.description &&
              U.description.toLowerCase().includes(k.toLowerCase())),
        )
      : [];
  return s.createElement(
    ot,
    ...
    s.createElement(
                          ...
                          s.createElement(
                            at,
                            {
                              ...
                              variant: A.has(P)
                                ...
                                : "outline-primary",
                              onClick: (H) => {
                                H.stopPropagation(), A.has(P) ? $(P) : R(P);
                              },
                      ...
                      );
                {
                  ...
                  return (
                    ...
                    Object.entries(i).forEach(([U, H]) => {
                      const Q = U.split("."),
                        J = Q.length > 1 ? Q.slice(0, -1).join(".") : "Root";
                      P[J] || (P[J] = []), P[J].push([U, H]);
                    }),
                    s.createElement(
                      ft,
                      { flush: !0 },
                      Object.entries(P)
                        .sort(([U], [H]) => U.localeCompare(H))
                        .map(([U, H]) =>
                          s.createElement(
                            ft.Item,
                            { key: U, eventKey: U },
          ...
          Array.from(A).map((P) => {
            ...
            return U
              ? s.createElement(
                  ...
                  s.createElement("div", { className: "flex-grow-1" }, _(P, U)),
                  s.createElement(
                    at,
                    {
                      variant: "link",
                    ...
                    s.createElement(kh, { size: 16, "aria-hidden": "true" }),
                  ),
                )
              : null;
          }),
        f && s.createElement(uk, { scan: f, schemata: i, onChange: T }),
        s.createElement(
          at,
          {
      ...
      s.createElement(
        ...
        s.createElement(
          ...
          s.createElement(Nr.Body, { className: "text-white" }, E),
        ),
      ),
    ),
  );
}
function fk({ explist: e, experiment: t, repo_rev: n }) {
  const [r, o] = s.useState(null),
    [l, a] = s.useState(!1),
    u = ((d) =>
      !d || !e || !e.experiments
        ? null
        : e.experiments.find((v) => `${v.file}:${v.class_name}` === d))(t);
  if (
    (s.useEffect(() => {
      if (!u) {
        o(null);
...
const gv = p.exports.forwardRef((e, t) => {
  let { onKeyDown: n } = e,
    r = mk(e, pk);
  const [o] = nc(Object.assign({ tagName: "a" }, r)),
    l = Ke((a) => {
      o.onKeyDown(a), n == null || n(a);
    });
  return hk(r.href) || r.role === "button"
    ? b.exports.jsx("a", Object.assign({ ref: t }, r, o, { onKeyDown: l }))
    : b.exports.jsx("a", Object.assign({ ref: t }, r, { onKeyDown: n }));
});
gv.displayName = "Anchor";
const yv = Ua("h4");
yv.displayName = "DivStyledAsH4";
const vk = je("alert-heading", { Component: yv }),
  gk = je("alert-link", { Component: gv }),
  yk = {
    variant: "primary",
    show: !0,
    transition: un,
  ...
  kc = p.exports.forwardRef((e, t) => {
    const {
      ...
      w = d === !0 ? un : d,
      k = b.exports.jsxs("div", {
        role: "alert",
        ...(w ? void 0 : v),
        ref: t,
        className: q(a, y, u && `${y}-${u}`, f && `${y}-dismissible`),
        children: [
          f && b.exports.jsx(Vr, { onClick: x, "aria-label": o, variant: l }),
          i,
        ],
      });
    return w
...
kc.defaultProps = yk;
const Ea = Object.assign(kc, { Link: gk, Heading: vk }),
  Cc = p.exports.forwardRef(
    (
      {
        bsPrefix: e,
      ...
      e = Z(e, "spinner");
      const u = `${e}-${n}`;
      return b.exports.jsx(o, {
        ref: i,
        ...a,
        className: q(l, u, r && `${u}-${r}`, t && `text-${t}`),
      });
    },
  );
Cc.displayName = "Spinner";
function xk(e) {
  const t = {};
  return (
    e.forEach((n) => {
...
Nc.propTypes = {
  name: O.exports.string.isRequired,
  node: O.exports.object.isRequired,
  selectedDatasets: O.exports.array.isRequired,
  onSelect: O.exports.func.isRequired,
  level: O.exports.number,
};
function xv({ datasetNames: e, selectedDatasets: t, onSelect: n }) {
  const r = xk(e);
  return e.length === 0
    ? s.createElement(
        "div",
...
xv.propTypes = {
  datasetNames: O.exports.array.isRequired,
  selectedDatasets: O.exports.array.isRequired,
  onSelect: O.exports.func.isRequired,
};
function Ev({ name: e, datasetData: t }) {
...
function Ek() {
  const [e, t] = p.exports.useState([]),
    ...
    [v, y] = p.exports.useState(null);
  p.exports.useEffect(() => {
    const h = async () => {
      try {
        const E = await $h();
        t(E.names), r(E.names), y(null);
      } catch (E) {
        y(`Failed to load datasets: ${E.message}`);
      } finally {
        d(!1);
      }
    };
    h();
    const g = setInterval(h, 5e3);
    ...
    p.exports.useEffect(() => {
      if (o.trim() === "") r(e);
        ...
        r(e.filter((g) => g.toLowerCase().includes(h)));
      }
    }, [o, e]);
  const [x, w] = Gu();
  p.exports.useEffect(() => {
    const h = x.getAll("select");
    h.length > 0 &&
      (i(h),
      yo(h)
        .then((g) => {
  ...
  const k = async (h) => {
      ...
      if (a.includes(h)) {
        ...
        try {
          ...
          y(`Failed to load dataset value: ${E.message}`);
        }
      }
      i(g),
        w((E) => {
          const S = new URLSearchParams(E);
          return S.delete("select"), g.forEach((N) => S.append("select", N)), S;
        });
    },
    m = async () => {
      if (a.length !== 0)
        try {
          ...
          y(`Failed to refresh dataset values: ${h.message}`);
        }
    };
  return f
    ? s.createElement(
          ...
          s.createElement(
            ...
            s.createElement(
              ...
              s.createElement(
                ...
                s.createElement(ih, { "aria-hidden": "true" }),
                " Refresh",
              ),
            ),
            s.createElement(
              ...
              a.length === 0
                ...
                : a.map((h) =>
                    s.createElement(
                      "div",
                      { key: h, className: "mb-3 pb-3 border-bottom" },
                      s.createElement(Ev, { name: h, datasetData: u[h] }),
                    ),
                  ),
            ),
          ),
...
const wk = window.location.origin,
  Ue = {
...
function Sk(e, t = {}) {
  const { enabled: n = !0, reconnectDelay: r = 3e3 } = t,
    ...
    [a, i] = p.exports.useState(Ue.CLOSED),
    [u, c] = p.exports.useState(null),
    f = p.exports.useRef(null),
    d = p.exports.useRef(null),
    v = p.exports.useRef(!0),
    y = p.exports.useRef(0),
    x = p.exports.useCallback((m) => {
      l((h) => (h ? { ...h, ...m } : m));
    }, []),
    w = p.exports.useCallback((m) => {
      l((h) => {
        if (!h) return h;
        const g = { ...h };
        return delete g[m], g;
    ...
    k = p.exports.useCallback(() => {
      ...
      (y.current = m),
        ...
        i(Ue.CONNECTING),
        c(null);
      const E = `${wk}/api/datasets/stream/${encodeURIComponent(e)}`,
        S = new EventSource(E);
      (f.current = S),
        S.addEventListener("init", (N) => {
          if (!!v.current)
            try {
              const C = JSON.parse(N.data);
              l(C), i(Ue.CONNECTED), c(null);
            } catch (C) {
              console.error("Failed to parse init event:", C);
            }
        }),
        S.addEventListener("update", (N) => {
          if (!!v.current)
            try {
              const C = JSON.parse(N.data);
              x(C);
        ...
        S.addEventListener("delete", (N) => {
          if (!!v.current)
            try {
              const { key: C } = JSON.parse(N.data);
              w(C);
            } catch (C) {
              console.error("Failed to parse delete event:", C);
            }
        }),
        S.addEventListener("heartbeat", () => {
          !v.current || i((N) => (N === Ue.CONNECTED ? N : Ue.CONNECTED));
        }),
        S.addEventListener("error", (N) => {
          if (!!v.current)
            try {
              const C = JSON.parse(N.data);
              c(C.message), i(Ue.ERROR);
            } catch {
              i(Ue.ERROR);
            }
        }),
  ...
  return (
    ...
    ),
    {
      ...
      connectionState: a,
      error: u,
      isConnected: a === Ue.CONNECTED,
      isConnecting: a === Ue.CONNECTING || a === Ue.RECONNECTING,
    }
  );
}
...
wa.propTypes = {
  dims: O.exports.oneOf(["0D", "1D", "2D"]),
  size: O.exports.number,
  accent: O.exports.bool,
};
function wv({ recentRuns: e, currentPrefix: t, onPick: n }) {
  ...
  const u = e.find((d) => d.prefix === t) || e[0],
    ...
    f = p.exports.useMemo(() => {
      const d = new Map();
      for (const v of c)
        d.has(v.expName) || d.set(v.expName, { dims: v.dims, runs: [] }),
          d.get(v.expName).runs.push(v);
      return [...d.entries()];
    }, [c]);
  return u
    ? s.createElement(
              ...
              f.map(([d, v]) =>
                s.createElement(
                  ...
                  s.createElement(
                    ...
                    s.createElement(wa, { dims: v.dims, size: 11 }),
                    s.createElement(
                      "span",
                      {
...
wv.propTypes = {
  recentRuns: O.exports.array.isRequired,
  currentPrefix: O.exports.string,
  onPick: O.exports.func.isRequired,
};
function kk() {
  return s.createElement(
    "span",
...
function Ki({
  ...
  return s.createElement(
    "div",
    { className: "p-topbar" },
    s.createElement(kk, null),
    s.createElement(
      "span",
      { className: "p-dim2", style: { fontSize: 11 } },
      "/",
    ),
    s.createElement(wv, { recentRuns: e, currentPrefix: t, onPick: n }),
    o === "live" &&
      s.createElement(
        "div",
...
Ki.propTypes = {
  ...
  currentPrefix: O.exports.string,
  onPick: O.exports.func.isRequired,
  progress: O.exports.string,
  status: O.exports.string,
  onCopy: O.exports.func,
};
Sv.propTypes = { onCopy: O.exports.func.isRequired };
function Ck({ c: e, isRadio: t, onClick: n }) {
  return s.createElement(
    "div",
    {
...
kv.propTypes = {
  mode: O.exports.oneOf(["0D", "1D", "2D"]).isRequired,
  channels: O.exports.array.isRequired,
  onToggle: O.exports.func,
  onPickMetric: O.exports.func,
  experiment: O.exports.string,
};
function Nk({ on: e }) {
  return e
    ? s.createElement(
...
Cv.propTypes = {
  runs: O.exports.array.isRequired,
  activeRid: O.exports.number,
  ghostPrefixes: O.exports.array,
  onToggleGhost: O.exports.func.isRequired,
  onPick: O.exports.func.isRequired,
  dims: O.exports.string,
};
function Sa(e, t, n) {
...
const Nv = "artiq_http.plots.channels.";
function _k(e) {
  if (!e) return null;
  try {
    const t = localStorage.getItem(Nv + e);
...
function Pk(e, t) {
  if (!!e)
    try {
      localStorage.setItem(Nv + e, JSON.stringify(t));
    } catch {}
}
function Qi({ xs: e, xLabel: t, yLabel: n, channels: r, ghosts: o = [] }) {
  ...
  p.exports.useEffect(() => {
    ...
    const T = new ResizeObserver(([F]) => {
      const V = F.contentRect;
      i({ w: Math.max(360, V.width), h: Math.max(220, V.height) });
    });
    return T.observe(l.current), () => T.disconnect();
  }, []);
  const f = r.filter((T) => T.on && T.values && T.values.length);
  ...
  for (const T of f)
    for (const F of T.values)
      !isFinite(F) || (F < g && (g = F), F > E && (E = F));
  if (!isFinite(g) || !isFinite(E) || g === E) (g = 0), (E = 1);
  else {
    const T = (E - g) * 0.08;
    (g -= T), (E += T);
  }
  const S = (T) => d + ((T - m) / (h - m || 1)) * w,
    N = (T) => y + (1 - (T - g) / (E - g || 1)) * k,
    C = Sa(m, h, 6),
    R = Sa(g, E, 5),
    $ = (T) => {
    ...
    K = u
      ? f.map((T) => {
          const F = T.values;
          let V = Math.round(((u.x - m) / (h - m || 1)) * (F.length - 1));
          return (
            (V = Math.max(0, Math.min(F.length - 1, V))),
            { key: T.key, color: T.color, value: F[V] }
          );
        })
      : [],
    G = u
    ...
    s.createElement(
      ...
      s.createElement(
        ...
        s.createElement(
          ...
          s.createElement("line", { x1: d, y1: y + k, x2: d + w, y2: y + k }),
        ...
        s.createElement(
          ...
          C.map((T) =>
            s.createElement(
              ...
              s.createElement("text", { x: S(T), y: y + k + 16 }, ht(T)),
            ),
          ),
        ),
        s.createElement(
          ...
          R.map((T) =>
            s.createElement(
              ...
              s.createElement("text", { x: d - 8, y: N(T) + 3 }, ht(T)),
            ),
          ),
        ),
        o.map((T, F) => {
          ...
          const Y = T.xs || e,
            _ = V.map((z, L) => {
              const A = Y[L];
              return !isFinite(z) || !isFinite(A) ? null : `${S(A)},${N(z)}`;
            })
              .filter(Boolean)
              .join(" ");
        ...
        f.map((T) => {
          const F = T.values,
            V = F.map((Y, _) => {
              const z = e[_];
              return !isFinite(Y) || !isFinite(z) ? null : `${S(z)},${N(Y)}`;
            })
              .filter(Boolean)
              .join(" ");
          return s.createElement(
...
function Tk({ cursor: e, xLabel: t, cursorReadouts: n, ghostReadouts: r }) {
  return s.createElement(
    "div",
    {
          ...
          s.createElement(
            ...
            n.map((o) =>
              s.createElement(
                ...
                o.key,
                " = ",
                s.createElement("b", null, ht(o.value)),
              ),
            ),
            r.map((o) =>
              s.createElement(
...
Qi.propTypes = {
  xs: O.exports.array.isRequired,
  xLabel: O.exports.string,
  yLabel: O.exports.string,
  channels: O.exports.array.isRequired,
  ghosts: O.exports.array,
};
function Rv({ xs: e, ys: t, values: n, xLabel: r, yLabel: o, metric: l }) {
  ...
  p.exports.useEffect(() => {
    ...
    const L = new ResizeObserver(([A]) => {
      ...
      c({ w: Math.max(360, W.width), h: Math.max(220, W.height) });
    });
  ...
  const {
      ...
      const L = [...new Set(e)].sort((te, ce) => te - ce),
        A = [...new Set(t)].sort((te, ce) => te - ce),
        W = L.length,
        P = A.length,
        U = new Map(L.map((te, ce) => [te, ce])),
        H = new Map(A.map((te, ce) => [te, ce])),
        Q = Array.from({ length: P }, () => new Array(W).fill(NaN));
      let J = 1 / 0,
        ie = -1 / 0;
      for (let te = 0; te < n.length; te++) {
        const ce = n[te];
        if (!isFinite(ce)) continue;
        const Ne = U.get(e[te]),
          Me = H.get(t[te]);
        Ne == null ||
          Me == null ||
          ((Q[Me][Ne] = ce), ce < J && (J = ce), ce > ie && (ie = ce));
      }
      return (
        (!isFinite(J) || !isFinite(ie) || J === ie) && ((J = 0), (ie = 1)),
        {
          grid: Q,
          cols: W,
          rows: P,
  ...
  if (
    (p.exports.useEffect(() => {
      const L = i.current;
      if (!L || !v || y === 0 || x === 0) return;
      const A = window.devicePixelRatio || 1;
      (L.width = Math.max(1, N) * A),
        (L.height = Math.max(1, C) * A),
        (L.style.width = N + "px"),
        (L.style.height = C + "px");
      const W = L.getContext("2d");
      W.imageSmoothingEnabled = !1;
      const P = W.createImageData(y, x),
        [U, H] = m,
        Q = H - U || 1;
      for (let ie = 0; ie < x; ie++)
        for (let te = 0; te < y; te++) {
          const ce = v[ie][te],
            Ne = isFinite(ce) ? (ce - U) / Q : 0,
            [Me, D, ee] = Ok(Ne),
            ne = ((x - 1 - ie) * y + te) * 4;
          (P.data[ne] = Me),
            (P.data[ne + 1] = D),
            (P.data[ne + 2] = ee),
            (P.data[ne + 3] = isFinite(ce) ? 255 : 0);
        }
      const J = document.createElement("canvas");
      (J.width = y),
        (J.height = x),
        J.getContext("2d").putImageData(P, 0, 0),
        W.clearRect(0, 0, L.width, L.height),
        W.drawImage(J, 0, 0, N * A, C * A);
    }, [v, y, x, N, C, m]),
    !v || y === 0 || x === 0)
  )
    return s.createElement(
  ...
  const [R, $] = w,
    ...
    V = (L) => {
      const A = L.currentTarget.getBoundingClientRect(),
        W = L.clientX - A.left,
        P = L.clientY - A.top;
      if (W < h || W > h + N || P < E || P > E + C) {
        d(null);
        return;
      }
      const U = R + ((W - h) / N) * ($ - R),
        H = j + (1 - (P - E) / C) * (I - j),
        Q = Math.min(y - 1, Math.max(0, Math.floor(((W - h) / N) * y))),
        J = Math.min(x - 1, Math.max(0, Math.floor((1 - (P - E) / C) * x)));
      d({ x: U, y: H, value: v[J][Q] });
    },
    Y = () => d(null),
    _ = f ? K(f.x) : null,
    z = f ? G(f.y) : null;
  return s.createElement(
    ...
    s.createElement(
      ...
      s.createElement(
        ...
        s.createElement(
          ...
          s.createElement("line", { x1: h, y1: E + C, x2: h + N, y2: E + C }),
          s.createElement("line", { x1: h, y1: E, x2: h, y2: E + C }),
          s.createElement("line", { x1: h + N, y1: E, x2: h + N, y2: E + C }),
          s.createElement("line", { x1: h, y1: E, x2: h + N, y2: E }),
        ),
        s.createElement(
          "g",
          { fontSize: "10", fill: "var(--p-ink70)", textAnchor: "middle" },
          T.map((L) =>
            s.createElement(
              ...
              s.createElement("text", { x: K(L), y: E + C + 16 }, ht(L)),
            ),
          ),
        ),
        s.createElement(
          ...
          F.map((L) =>
            s.createElement(
              ...
              s.createElement("text", { x: h - 8, y: G(L) + 3 }, ht(L)),
            ),
          ),
        ),
        f &&
          s.createElement(
            ...
            s.createElement("line", { x1: _, x2: _, y1: E, y2: E + C }),
            s.createElement("line", { x1: h, x2: h + N, y1: z, y2: z }),
            s.createElement("circle", {
              cx: _,
              cy: z,
              r: "4",
        ...
        s.createElement(
          "g",
          { transform: `translate(${h + N + 18}, ${E})` },
          s.createElement($k, { height: C }),
          s.createElement(
            "text",
    ...
    s.createElement(bk, { cursor: f, metric: l, xLabel: r, yLabel: o }),
  );
}
function bk({ cursor: e, metric: t, xLabel: n, yLabel: r }) {
  return s.createElement(
    "div",
    {
      className: "p-panel-soft p-cursor-readout",
...
Rv.propTypes = {
  xs: O.exports.array.isRequired,
  ys: O.exports.array.isRequired,
  values: O.exports.array.isRequired,
  xLabel: O.exports.string,
  yLabel: O.exports.string,
  metric: O.exports.string,
};
function Ov({ channels: e }) {
...
Ov.propTypes = { channels: O.exports.array.isRequired };
function jk(e, t) {
  return e.replace(
    /var\((--[^,)]+)(?:,[^)]*)?\)/g,
    (n, r) => t.getPropertyValue(r).trim() || "currentColor",
  );
}
function Mk(e) {
...
async function Ik({
  ...
  const o = e.closest(".plots-app") || e,
    l = getComputedStyle(o),
    a = l.getPropertyValue("--p-bg").trim() || "#0e0f10",
    i = l.getPropertyValue("--p-panel").trim() || "#16191c",
    u = l.getPropertyValue("--p-border").trim() || "#2a2f35",
    c = l.getPropertyValue("--p-accent").trim() || "#f08a4d",
    f = l.getPropertyValue("--p-ink").trim() || "#e8e6df",
    d = l.getPropertyValue("--p-ink50").trim() || "rgba(232,230,223,0.52)",
    v = 30;
  let y, x, w;
  if (n === "1D" || n === "2D") {
    const E = e.querySelector("svg");
    if (!E) throw new Error("No SVG element found in plot container");
    (y = parseInt(E.getAttribute("width"), 10) || E.clientWidth || 800),
      (x = parseInt(E.getAttribute("height"), 10) || E.clientHeight || 460);
    const S = new XMLSerializer().serializeToString(E),
      N = jk(S, l),
      C = await Mk(N);
    let R = null;
    if (n === "2D") {
      const $ = e.querySelector("canvas");
      if ($) {
        const j = e.getBoundingClientRect(),
          I = $.getBoundingClientRect();
        R = {
          el: $,
          x: Math.round(I.left - j.left),
          y: Math.round(I.top - j.top),
          w: I.width,
          h: I.height,
        };
      }
    ...
    w = ($) => {
      ($.fillStyle = a),
        $.fillRect(0, 0, y, x),
        R && $.drawImage(R.el, R.x, R.y, R.w, R.h),
        $.drawImage(C, 0, 0, y, x);
    };
  } else {
    const E = r.filter((I) => I.on),
      S = Math.max(1, Math.ceil(Math.sqrt(E.length || 1))),
      N = Math.ceil((E.length || 1) / S),
      C = 200,
      R = 110,
      $ = 12,
      j = 12;
    (y = Math.max(300, S * (C + $) - $ + j * 2)),
      (x = Math.max(140, N * (R + $) - $ + j * 2)),
      (w = (I) => {
        (I.fillStyle = a),
          I.fillRect(0, 0, y, x),
          E.forEach((K, G) => {
            ...
            (I.fillStyle = i),
              ...
              I.fill(),
              I.stroke(),
              (I.fillStyle = K.color || c),
              I.fillRect(V + 12, Y + 16, 14, 3),
              (I.fillStyle = f),
              (I.font = "bold 11px monospace"),
              (I.textAlign = "left"),
              (I.textBaseline = "top");
            const _ = K.key.length > 22 ? K.key.slice(0, 20) + "\u2026" : K.key;
            I.fillText(_, V + 30, Y + 12);
            const z = K.point,
              L =
                z == null || !isFinite(z) ? "\u2014" : Number(z).toPrecision(5);
            (I.fillStyle = K.color || c),
              (I.font = "bold 30px monospace"),
              (I.textBaseline = "middle"),
              I.fillText(L, V + 12, Y + 68, C - 24),
              K.unit &&
                ((I.fillStyle = d),
                (I.font = "10px monospace"),
                (I.textBaseline = "bottom"),
                I.fillText(K.unit, V + 12, Y + R - 8));
          });
      });
  }
  const k = document.createElement("canvas");
  (k.width = y), (k.height = x + v);
  ...
  (m.textBaseline = "middle"),
    (m.fillStyle = f),
    (m.font = 'bold 11px system-ui, -apple-system, "Segoe UI", sans-serif'),
    (m.textAlign = "left"),
    m.fillText("ARTIQ", 10, h),
    t != null &&
      ((m.fillStyle = c),
    ...
    (m.textAlign = "right"),
    m.fillText(new Date().toLocaleString(), y - 10, h);
  const g = await new Promise((E) => k.toBlob(E, "image/png"));
  if (!g) throw new Error("Failed to generate PNG blob");
  if (typeof navigator < "u" && navigator.clipboard && window.ClipboardItem)
    await navigator.clipboard.write([new ClipboardItem({ "image/png": g })]);
  else {
    const E = URL.createObjectURL(g),
      S = document.createElement("a");
    (S.href = E),
      (S.download = `artiq-plot${t != null ? `-rid${t}` : ""}.png`),
    ...
    const c = JSON.parse(i[1]),
      ...
      d =
        (r = (n = e[`${t}.completed`]) == null ? void 0 : n[1]) != null
          ? r
          : !1,
      v = ((o = e[`${t}.fragment_fqn`]) == null ? void 0 : o[1]) || null,
      y = c.map((w, k) => {
        var m;
        return ((m = e[`${t}.points.axis_${k}`]) == null ? void 0 : m[1]) || [];
      }),
      x = {};
    for (const w of Object.keys(f)) {
      const k = (l = e[`${t}.points.channel_${w}`]) == null ? void 0 : l[1],
        m = (a = e[`${t}.point.${w}`]) == null ? void 0 : a[1];
      x[w] = { values: k || [], point: m };
    }
    return {
      prefix: t,
      axes: c,
...
function Bk() {
  ...
  const [e, t] = Gu(),
    ...
    [c, f] = p.exports.useState(!1),
    d = p.exports.useCallback(async () => {
      try {
        const ae = ((await $h()).names || [])
          .filter((re) => re.endsWith(".axes"))
          .map((re) => re.replace(/\.axes$/, ""))
          .sort((re, _e) => {
            const Be = In(re),
              We = In(_e);
            return Be != null && We != null ? We - Be : _e.localeCompare(re);
          });
        if (ae.length === 0) {
          o((re) => (re.length === 0 ? re : [])), a({}), u(null);
          return;
        }
        const ne = ae.flatMap((re) => [`${re}.fragment_fqn`, `${re}.axes`]),
          Ee = await yo(ne),
          fe = {};
        for (const re of ae) {
          const _e = Ee[`${re}.fragment_fqn`],
            Be = Ee[`${re}.axes`];
          let We = null;
          if (Be)
            try {
              We = `${JSON.parse(Be[1]).length}D`;
            } catch {}
          fe[re] = { fragmentFqn: _e ? _e[1] : null, dims: We };
        }
        o((re) => (JSON.stringify(re) === JSON.stringify(ae) ? re : ae)),
          a(fe),
          u(null);
      } catch (D) {
        u(D.message || String(D));
      } finally {
        f(!0);
      }
    }, []);
  ...
  p.exports.useEffect(() => {
    ...
    v.length && !y && x(v[0].prefix);
  }, [e, v, y]);
  const w = p.exports.useCallback(
      (D) => {
        x(D.prefix);
        const ee = new URLSearchParams(e);
        ee.set("scan", D.prefix), t(ee, { replace: !0 });
      },
      [e, t],
    ),
    { data: k, connectionState: m, error: h } = Sk(y, { enabled: !!y }),
    g = p.exports.useMemo(() => Fk(k, y), [k, y]),
    E =
      (g == null ? void 0 : g.dims) ||
      ((Ne = l[y]) == null ? void 0 : Ne.dims) ||
      null,
    S =
      (g == null ? void 0 : g.fragmentFqn) ||
      ((Me = l[y]) == null ? void 0 : Me.fragmentFqn) ||
      null,
    N = S || (y || "").replace(/^ndscan\./, ""),
    C =
      g != null && g.channels ? Object.keys(g.channels).sort().join("\0") : "",
    R = p.exports.useMemo(() => (C ? C.split("\0") : []), [C]),
    [$, j] = p.exports.useState({});
  p.exports.useEffect(() => {
    if (!R.length) return;
    const D = _k(S);
    j((ee) => {
      ...
      for (let Ee = 0; Ee < R.length; Ee++) {
        ...
        if (D && fe in D) {
          const re = !!D[fe];
          ne[fe] !== re && ((ne[fe] = re), (ae = !0));
        } else fe in ne || ((ne[fe] = Ee < 3), (ae = !0));
      }
      return ae ? ne : ee;
    });
  }, [S, R]);
  const I = p.exports.useCallback(
      (D) => {
        j((ee) => {
          const ae = { ...ee, [D]: !ee[D] };
          return Pk(S, ae), ae;
    ...
    [K, G] = p.exports.useState(null);
  p.exports.useEffect(() => {
    E === "2D" && R.length && !R.includes(K) && G(R[0]);
  }, [E, R, K]);
  const [T, F] = p.exports.useState([]),
    V = p.exports.useRef(null);
  p.exports.useEffect(() => {
    F([]), (V.current = null);
  }, [y]),
    p.exports.useEffect(() => {
      var Ee;
      if (!g || g.axes.length !== 0) return;
      const D = Object.keys(g.channels),
        ee = {};
      let ae = !1;
      for (const fe of D) {
        const re =
          (Ee = k == null ? void 0 : k[`${y}.point.${fe}`]) == null
            ? void 0
            : Ee[1];
        re !== void 0 && ((ee[fe] = re), (ae = !0));
      }
      if (!ae) return;
      const ne = V.current;
      (!ne || D.some((fe) => ee[fe] !== ne[fe])) &&
        ((V.current = ee), F((fe) => [...fe, { t: Date.now(), snap: ee }]));
    }, [k, g, y]);
  const Y = p.exports.useMemo(() => {
      if (!g || g.axes.length !== 0 || T.length === 0) return null;
      const D = T[0].t,
        ee = T.map((ne) => (ne.t - D) / 1e3),
        ae = {};
      for (const ne of Object.keys(g.channels))
        ae[ne] = T.map((Ee) => Ee.snap[ne]);
      return { xs: ee, channelValues: ae };
    }, [T, g]),
    _ = p.exports.useMemo(
      () =>
        g
          ? R.map((D, ee) => {
              const ae = g.channels[D] || {},
                ne = g.channelData[D] || {},
                Ee = dd[ee % dd.length],
                re = E === "2D" ? E === "2D" && D === K : !!$[D];
              return {
    ...
    L = p.exports.useCallback(async () => {
      if (!z.current || !E) throw new Error("No plot to copy");
      await Ik({
        containerEl: z.current,
        rid: In(y || ""),
        dims: E,
        channelDescriptors: _,
      });
    }, [y, E, _]),
    A = v,
    [W, P] = p.exports.useState([]);
  p.exports.useEffect(() => {
    P([]);
  }, [y]);
  const U = p.exports.useCallback((D) => {
      P((ee) => (ee.includes(D) ? ee.filter((ae) => ae !== D) : [...ee, D]));
    }, []),
    [H, Q] = p.exports.useState({});
  p.exports.useEffect(() => {
    Q((D) => (Object.keys(D).length === 0 ? D : {}));
  }, [y]);
  const J = W.join(" ");
  p.exports.useEffect(() => {
    if (E !== "1D" || W.length === 0) return;
    let D = !1;
    async function ee() {
      const ae = W.filter((ne) => !H[ne]);
      if (!!ae.length)
        try {
          const ne = ae.flatMap((fe) => [
              `${fe}.points.axis_0`,
              ...R.map((re) => `${fe}.points.channel_${re}`),
            ]),
            Ee = await yo(ne);
          if (D) return;
          Q((fe) => {
            ...
            for (const We of ae) {
              const cn =
                  ((_e = Ee[`${We}.points.axis_0`]) == null ? void 0 : _e[1]) ||
                  [],
                fn = R[0],
                le = fn
                  ? ((Be = Ee[`${We}.points.channel_${fn}`]) == null
                      ? void 0
                      : Be[1]) || []
                  : [];
              re[We] = { xs: cn, values: le, rid: In(We) };
            }
            return re;
          });
        } catch (ne) {
          console.error("Failed to load ghost data:", ne);
        }
    }
    return (
      ee(),
  ...
  const ie = p.exports.useMemo(
      () =>
        E !== "1D"
          ? []
          : W.map((D) => H[D]).filter((D) => D && D.values && D.values.length),
      [W, H, E],
    ),
    te = p.exports.useMemo(
      () =>
        y
          ? m === Ue.ERROR
            ? "error"
            : m === Ue.CONNECTING || m === Ue.RECONNECTING
              ? "connecting"
              : g != null && g.completed
                ? "done"
                : "live"
    ...
    ce = p.exports.useMemo(() => {
      var D;
      return g
        ? E === "1D" || E === "2D"
          ? `${((D = g.axisValues[0]) == null ? void 0 : D.length) || 0} pts`
          : E === "0D" && T.length > 0
            ? `${T.length} pts`
            : "streaming"
        : "";
...
function _v({ prefix: e, rid: t, fragmentFqn: n, dims: r }) {
  return e
    ? s.createElement(
        "div",
        {
...
function Pv({
  ...
  if (t === "0D") {
    ...
    return s.createElement(Ov, { channels: c });
  }
  if (t === "1D") {
  ...
  if (t === "2D") {
    const c = e.axisValues[0] || [],
      ...
      v = ((u = e.channelData[d]) == null ? void 0 : u.values) || [];
...
Pv.propTypes = {
  active: O.exports.object,
  dims: O.exports.string,
  channelDescriptors: O.exports.array.isRequired,
  metric2D: O.exports.string,
  ghosts: O.exports.array,
  status: O.exports.string,
  sseError: O.exports.string,
  timeseries0D: O.exports.object,
};
_v.propTypes = {
  prefix: O.exports.string,
  rid: O.exports.number,
  fragmentFqn: O.exports.string,
  dims: O.exports.string,
};
function Tv() {
  return s.createElement(Bk, null);
}
var Cl;
function pd(e) {
  if (((!Cl && Cl !== 0) || e) && Ur) {
...
function Vk(e = document) {
  const t = e.defaultView;
  return Math.abs(t.innerWidth - e.documentElement.clientWidth);
}
const md = Uk("modal-open");
class Rc {
  constructor({
    ownerDocument: t,
...
function Qk(e) {
  return (
    Rs || (Rs = new Rc({ ownerDocument: e == null ? void 0 : e.document })), Rs
  );
}
function Gk(e) {
  const t = uv(),
...
const bv = p.exports.forwardRef((e, t) => {
  let {
      show: n = !1,
      role: r = "dialog",
      className: o,
      ...
      renderDialog: m,
      renderBackdrop: h = (D) => b.exports.jsx("div", Object.assign({}, D)),
      manager: g,
      container: E,
      onShow: S,
      onHide: N = () => {},
  ...
  const T = Vi(E),
    ...
    V = oc(),
    Y = dk(n),
    [_, z] = p.exports.useState(!n),
    L = p.exports.useRef(null);
  p.exports.useImperativeHandle(t, () => F, [F]),
    Ur && !Y && n && (L.current = Ns()),
    !d && !n && !_ ? z(!0) : n && _ && z(!1);
  const A = Ke(() => {
      if (
        (F.add(),
        (J.current = Kt(document, "keydown", H)),
        (Q.current = Kt(document, "focus", () => setTimeout(P), !0)),
        S && S(),
        y)
      ) {
        const D = Ns(document);
    ...
    W = Ke(() => {
      if (
        ...
        var D;
        (D = L.current) == null || D.focus == null || D.focus(k),
          (L.current = null);
      }
    });
  p.exports.useEffect(() => {
  ...
  const P = Ke(() => {
      if (!x || !V() || !F.isTopModal()) return;
      const D = Ns();
      F.dialog && D && !Bo(F.dialog, D) && F.dialog.focus();
    }),
    U = Ke((D) => {
      D.target === D.currentTarget && (c == null || c(D), i === !0 && N());
    }),
    H = Ke((D) => {
      u &&
        D.keyCode === 27 &&
        F.isTopModal() &&
        (f == null || f(D), D.defaultPrevented || N());
    }),
    Q = p.exports.useRef(),
    J = p.exports.useRef(),
    ie = (...D) => {
  ...
  if (i) {
    const D = v;
    (Me = h({ ref: F.setBackdropRef, onClick: U })),
      D && (Me = b.exports.jsx(D, { appear: !0, in: !!n, children: Me }));
  }
  return b.exports.jsx(b.exports.Fragment, {
    children: Un.createPortal(
      b.exports.jsxs(b.exports.Fragment, { children: [Me, Ne] }),
      T,
    ),
  });
});
bv.displayName = "Modal";
const qk = Object.assign(bv, { Manager: Rc });
function Yk(e, t) {
  e.classList
    ? e.classList.add(t)
    : fv(e, t) ||
...
var Xk = Function.prototype.bind.call(Function.prototype.call, [].slice);
function or(e, t) {
  return Xk(e.querySelectorAll(t));
}
function hd(e, t) {
  return e
...
function Jk(e, t) {
  e.classList
    ...
    : typeof e.className == "string"
      ? (e.className = hd(e.className, t))
      : e.setAttribute(
          "class",
          hd((e.className && e.className.baseVal) || "", t),
        );
}
const lr = {
...
class Zk extends Rc {
  ...
  setContainerStyle(t) {
    ...
    const n = this.getElement();
    if ((Yk(n, "modal-open"), !t.scrollBarWidth)) return;
...
let Os;
function e2(e) {
  return Os || (Os = new Zk(e)), Os;
}
const t2 = je("modal-body"),
  $v = p.exports.createContext({ onHide() {} }),
...
Oc.displayName = "ModalDialog";
const n2 = je("modal-footer"),
  r2 = { closeLabel: "Close", closeButton: !1 },
  Lv = p.exports.forwardRef(
    (
      {
        closeLabel: e,
        closeVariant: t,
      ...
      const i = p.exports.useContext($v),
        u = Ke(() => {
      ...
      return b.exports.jsxs("div", {
        ...
        children: [
          o,
          n && b.exports.jsx(Vr, { "aria-label": e, variant: t, onClick: u }),
        ],
      });
    },
  );
Lv.defaultProps = r2;
const o2 = { closeLabel: "Close", closeButton: !1 },
  _c = p.exports.forwardRef(
    ({ bsPrefix: e, className: t, ...n }, r) => (
      (e = Z(e, "modal-header")),
      b.exports.jsx(Lv, { ref: r, ...n, className: q(t, e) })
    ),
  );
_c.displayName = "ModalHeader";
_c.defaultProps = o2;
const l2 = Ua("h4"),
  a2 = je("modal-title", { Component: l2 }),
  s2 = {
    show: !1,
    backdrop: !0,
    keyboard: !0,
...
function i2(e) {
  return b.exports.jsx(un, { ...e, timeout: null });
}
function u2(e) {
  return b.exports.jsx(un, { ...e, timeout: null });
}
const Pc = p.exports.forwardRef(
  (
    {
      bsPrefix: e,
      className: t,
    ...
    const [V, Y] = p.exports.useState({}),
      [_, z] = p.exports.useState(!1),
      L = p.exports.useRef(!1),
      A = p.exports.useRef(!1),
      W = p.exports.useRef(null),
      [P, U] = ya(),
      H = Zo(F, U),
      Q = Ke(k),
      J = qu();
    e = Z(e, "modal");
    const ie = p.exports.useMemo(() => ({ onHide: Q }), [Q]);
    function te() {
      return G || e2({ isRTL: J });
    }
    function ce(le) {
      if (!Ur) return;
      const Bt = te().getScrollbarWidth() > 0,
        Hr = le.scrollHeight > Wr(le).documentElement.clientHeight;
      Y({
        paddingRight: Bt && !Hr ? pd() : void 0,
        paddingLeft: !Bt && Hr ? pd() : void 0,
      });
    }
    const Ne = Ke(() => {
      P && ce(P.dialog);
    ...
    lc(() => {
      Ni(window, "resize", Ne), W.current == null || W.current();
    });
    const Me = () => {
        L.current = !0;
      },
      D = (le) => {
        L.current && P && le.target === P.dialog && (A.current = !0),
          (L.current = !1);
      },
      ee = () => {
        z(!0),
          (W.current = nh(P.dialog, () => {
            z(!1);
          }));
      },
      ae = (le) => {
        le.target === le.currentTarget && ee();
      },
      ne = (le) => {
        if (v === "static") {
          ae(le);
      ...
      Ee = (le) => {
        y ? x == null || x(le) : (le.preventDefault(), v === "static" && ee());
      },
      fe = (le, Bt) => {
        le && ce(le), $ == null || $(le, Bt);
      },
      re = (le) => {
        W.current == null || W.current(), C == null || C(le);
      },
      _e = (le, Bt) => {
        j == null || j(le, Bt), th(window, "resize", Ne);
      },
      Be = (le) => {
        le && (le.style.display = ""),
          I == null || I(le),
      ...
      We = p.exports.useCallback(
        (le) =>
          b.exports.jsx("div", {
            ...le,
            className: q(`${e}-backdrop`, K, !d && "show"),
          }),
        [d, K, e],
      ),
      cn = { ...n, ...V };
    ...
    const fn = (le) =>
      b.exports.jsx("div", {
        ...
        ...le,
        style: cn,
        className: q(t, e, _ && `${e}-static`, !d && "show"),
        onClick: v ? ne : void 0,
        onMouseUp: D,
        "aria-label": c,
        "aria-labelledby": i,
        "aria-describedby": u,
        children: b.exports.jsx(a, {
          ...T,
          onMouseDown: Me,
          className: r,
          contentClassName: o,
    ...
    return b.exports.jsx($v.Provider, {
      value: ie,
      children: b.exports.jsx(qk, {
        show: f,
        ref: H,
        backdrop: v,
        container: m,
        ...
        onExited: Be,
        manager: te(),
        transition: d ? i2 : void 0,
        backdropTransition: d ? u2 : void 0,
        renderBackdrop: We,
        renderDialog: fn,
      }),
    });
...
Pc.displayName = "Modal";
Pc.defaultProps = s2;
const Nl = Object.assign(Pc, {
  Body: t2,
  Header: _c,
  Title: a2,
  Footer: n2,
...
function jv({ errorType: e, show: t }) {
  const r = (() => {
    switch (e) {
      case "backend":
        return {
...
jv.propTypes = {
  errorType: O.exports.oneOf(["backend", "artiq", null]),
  show: O.exports.bool.isRequired,
};
...
function vd(e) {
  ...
  for (const t of Mv) if (e >= t.value) return t;
...
function d2({ currentPage: e }) {
  const [t, n] = p.exports.useState([]),
    ...
    w = p.exports.useCallback(async (m = !1) => {
      const h = Date.now();
      (y.current = h), m ? a(!0) : o(!0);
      try {
        const g = await SE();
        if (y.current !== h) return;
  ...
  p.exports.useEffect(() => {
    ...
    p.exports.useEffect(() => {
      const m = setInterval(() => {
        document.visibilityState === "visible" && e === "logs" && w(!0);
      }, c2);
  ...
  const k = p.exports.useMemo(
    () =>
      t
        .filter((m) => (typeof m.level == "number" ? m.level : 0) >= c)
        .sort((m, h) => h.timestamp - m.timestamp),
    [t, c],
  );
  return r
    ? s.createElement(
              ...
              s.createElement(
                ...
                s.createElement(
                  ...
                  s.createElement(
                    ...
                    k.map((m, h) => {
                      var S, N;
                      const { name: g, className: E } = vd(m.level);
                      return s.createElement(
                        "tr",
                        { key: h },
                        s.createElement(
...
function p2({ currentPage: e, onPageChange: t }) {
  const n = [
    { id: "running", label: "Running", Icon: Gx },
    { id: "datasets", label: "Datasets", Icon: Nx },
    { id: "plots", label: "Plots", Icon: hh },
    { id: "schedule", label: "Schedule", Icon: Vx },
    { id: "configure", label: "Configure", Icon: tE },
    { id: "logs", label: "Logs", Icon: Ax },
  ];
  return s.createElement(
    "nav",
...
function v2({ currentPage: e, isOnline: t }) {
  return s.createElement(
    "header",
...
function y2() {
  const [e, t] = p.exports.useState(null),
    ...
    [u] = Gu(),
    f = ((w) =>
      w.startsWith("/datasets")
        ? "datasets"
        : w.startsWith("/plots")
          ? "plots"
          : w.startsWith("/schedule")
            ? "schedule"
            : w.startsWith("/configure")
              ? "configure"
              : w.startsWith("/running")
                ? "running"
                : w.startsWith("/logs")
                  ? "logs"
                  : "schedule")(a.pathname);
  p.exports.useEffect(() => {
    const w = u.get("experiment"),
      k = u.get("rev");
    w && (t(w), r(k));
  }, [u]);
  const d = (w) => {
  ...
  p.exports.useEffect(() => {
    const w = document.getElementById(`section-${f}`);
  ...
  p.exports.useEffect(() => {
    const w = () => {
      xE()
        .then(y)
        .catch((m) =>
          console.error("Experiment list update error:", m.message),
        );
    };
    w();
    const k = setInterval(w, 1e4);
    return () => clearInterval(k);
  }, []);
  const x = (w) => {
    const k = w.experiment,
      m = `${k.file}:${k.class_name}`;
    t(m), r(v.repo_rev);
    const h = new URLSearchParams();
    h.set("experiment", m),
      v.repo_rev && h.set("rev", v.repo_rev),
      i({ pathname: "/configure", search: h.toString() }),
      setTimeout(() => {
  ...
  return (
    ...
    p.exports.useEffect(() => {
      const w = async () => {
        try {
          (await wE()).artiq_connected ? l(null) : l("artiq");
        } catch {
          l("backend");
        }
      };
      w();
      const k = setInterval(w, g2);
      return () => clearInterval(k);
    }, []),
    a.pathname === "/plots/fullscreen"
      ? s.createElement(m2, null)
      : s.createElement(
          "div",
          { className: "app-container" },
          s.createElement(jv, { errorType: o, show: o !== null }),
          s.createElement(v2, { currentPage: f, isOnline: o === null }),
          s.createElement(
            Yu,
            ...
            s.createElement(
              ...
              s.createElement(
                ...
                s.createElement(
                  rr,
                  { title: "Running" },
                  s.createElement(ar, null, s.createElement(bE, null)),
                ),
              ),
            ),
            s.createElement(
              ...
              s.createElement(
                ...
                s.createElement(
                  ...
                  s.createElement(ar, null, s.createElement(Ek, null)),
                ),
              ),
            ),
            s.createElement(
              ...
              s.createElement(
                ...
                s.createElement(
                  ...
                  s.createElement(ar, null, s.createElement(Tv, null)),
                ),
              ),
            ),
            s.createElement(
              ...
              s.createElement(
                ...
                s.createElement(
                  ...
                  s.createElement(
                    ar,
                    null,
                    s.createElement(d2, { currentPage: f }),
                  ),
                ),
              ),
            ),
          ),
          s.createElement(p2, { currentPage: f, onPageChange: d }),
        )
  );
}
Om(document.getElementById("root")).render(
  s.createElement(R1, null, s.createElement(y2, null)),
);
