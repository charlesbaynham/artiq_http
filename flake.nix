  ...
  outputs = { self, nixpkgs, flake-utils, mach-nix, sipyco }:
    flake-utils.lib.eachDefaultSystem (system:
      ...
      rec {
        packages = rec {
          ...
          docs_html = pkgs.stdenv.mkDerivation {
            ...
            buildPhase = ''
              cp -r $src/* .
              chmod -R +w .
              sphinx-apidoc -o docs/autogen "artiq_http"
        ...
        defaultPackage = packages.artiq_http;

        devShell = pkgs.mkShell {
          name = "artiq_http-devShell";
          buildInputs = devReqs;
        };
