#!/usr/bin/env python
#
# artiq_http documentation build configuration file, created by
# cookiecutter
#
...
project_title = "artiq_http".replace("_", " ").title()
...
# Else, attempt to get it from the package
    ...
    version = artiq_http.__version__
...
htmlhelp_basename = "artiq_httpdoc"
